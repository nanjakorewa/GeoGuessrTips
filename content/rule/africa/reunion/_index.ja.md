...
{{% notice tip %}}
Google Carが特徴的で<span class="quiz">右後ろ</span>に黒いテープが巻いてある{{% ex "https://maps.app.goo.gl/BS58dK23qowSRfno7" %}}。
{{% /notice %}}
...
{{% notice tip %}}
平地ではサトウキビの生産が多い{{% ref "https://www.laperruche.fr/ja/sugar-cane/" "la Perruche" %}}。
{{% /notice %}}
<div class="googlemap-if">
