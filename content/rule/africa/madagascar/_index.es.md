...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>El dominio es <span class="quiz">.mg</span></li>
        <li>Es necesario aprender todas las ubicaciones ya que no se utiliza Google Car y las ubicaciones son limitadas.</li>
    </ul>
</div>
