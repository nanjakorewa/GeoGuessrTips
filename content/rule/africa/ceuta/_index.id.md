...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        ...
        <li>Domainnya adalah <span class="quiz">.es</span></li>
        <li>Mobil sering kali kotor oleh pasir.</li>
    </ul>
...
{{% tab "w-etf" %}}
{{% notice tip %}}
Mobil sering kali kotor oleh pasir.
{{% /notice %}}
...
{{% notice tip %}}
Ada pagar pembatas berwarna hitam dan putih.
{{% /notice %}}
<div class="googlemap-if">
...
{{% notice tip %}}
Terkadang rambu penyeberangan dikelilingi oleh garis kuning.
{{% /notice %}}
