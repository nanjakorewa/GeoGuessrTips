...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>Country domain: <span class="quiz">.tn</span></li>
        <li>Arabic is the official language, but <span class="quiz">French</span> is also widely used</li>
        <li>Many buildings are dominated by <span class="quiz">bright light blue and white</span></li>
        <li><span class="quiz">Black</span> license plates exist</li>
        <li>A car often follows behind</li>
        <li class="no-evidence">Light-blue bags are often discarded along the roadside?</li>
    </ul>
</div>
...
{{% notice tip %}}
Distinctive mesh-patterned utility poles can be found{{% ex "https://maps.app.goo.gl/hqXfjySphhMKgX5BA" "https://maps.app.goo.gl/EFV8RDZC1zBjY2WVA" "https://maps.app.goo.gl/6FCynZ4NfJy7T5828" "https://maps.app.goo.gl/NvMPNpqyVML678oj9" "https://maps.app.goo.gl/dcHxnvg6oJpsGxYA9" "https://goo.gl/maps/DepnkcPuYJJiCaP2A" %}}.
{{% /notice %}}
...
{{% notice tip %}}
There are <span class="quiz">black</span> license plates, though other colors exist as well. A dark-colored car often follows behind the Google car{{% ex "https://goo.gl/maps/YkhCfF27ZJG89csn9" "https://goo.gl/maps/XXwAXtpEehF6fKxm9" %}}{{% imref "Image source - edited" %}}.
{{% /notice %}}
...
{{% tab "Light blue bags" %}}
{{% notice tip %}}
Light-blue bags or plastic tape (?) are often discarded along the roadside
{{% /notice %}}
<div class="googlemap-if">
