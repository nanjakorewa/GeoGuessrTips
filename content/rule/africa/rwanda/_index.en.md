...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        ...
        <li>Roads are clean with little trash and well‑trimmed grass</li>
        <li>License plates are slim: <span class="quiz">white</span> front and <span class="quiz">yellow</span> rear</li>
        <li>Mobile payment is widespread; kiosks for operators like MTN are common</li>
        <li>Square utility poles appear</li>
...
{{% notice tip %}}In Rwanda, a mandatory community service called Umuganda includes road cleaning, mowing, and trimming street trees each week{{% ref "https://en.wikipedia.org/wiki/Umuganda" "Umuganda" %}}. As a result, roads look relatively clean for Africa. There is little trash{{% ex "https://maps.app.goo.gl/BNJ8TsYNd1vuxFcTA" "https://maps.app.goo.gl/TrwV5Eef5at2EQkM6" "https://maps.app.goo.gl/wPExCyEJLQ51RjJw8" %}}, and even unpaved roads often have neatly cut grass{{% ex "https://maps.app.goo.gl/DNr28FbdhqSiQwkQ9" "https://maps.app.goo.gl/VaortNd9suh4qnPB9"  "https://maps.app.goo.gl/WqgccX5XGvA2CYLW8" "https://maps.app.goo.gl/aFo1m4oH7haLFVoe9" %}}.
{{% /notice %}}
...
{{% notice tip %}}In Kigali, larger roads have many motorcycles{{% ex "https://goo.gl/maps/qmZFNBoLJeySYjYW6" "https://goo.gl/maps/E1xfd2c3wo91f2JS9" "" %}}. Unlike Uganda, cars drive on the <span class="quiz">right</span>. Plates are slim and can be <span class="quiz">yellow</span> or white.
{{% /notice %}}
<div class="googlemap-if no-margin">
...
{{% notice tip %}}The Google car is distinctive{{% ex "https://maps.app.goo.gl/eyqRzrvzY9mzwEam6" "https://maps.app.goo.gl/Bqp7fuYgZov4RkJD6" "https://maps.app.goo.gl/2Uhh25DhJewmtJxz7" %}}. It may be invisible at times{{% ex "https://maps.app.goo.gl/2FqppL8ioKU8X8Cm6" "https://goo.gl/maps/mTw1XkGeJkVqLsxU8" %}}.
{{% /notice %}}
<div class="googlemap-if">
...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>There are volcanoes near the northern border, and the soil around them looks black</li>
    </ul>
</div>
...
{{% notice tip %}}In town the soil is black{{% ex "https://maps.app.goo.gl/YMqbFGtnpsW9YivG8" "https://maps.app.goo.gl/wLNoXmSSqAobE4WN6" "https://maps.app.goo.gl/wtgmsRKztAcoJt1P7" %}}, and from the outskirts you can see the volcanoes.
{{% /notice %}}
<div class="googlemap-if no-margin">
...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>There are towns and roads along Lake Kivu on the DRC side{{% ex "https://maps.app.goo.gl/ZcYG1qAoUR63Mf867" "https://maps.app.goo.gl/sU2kpL1uezPnfFvs8" %}}{{% ref "https://en.wikipedia.org/wiki/Lake_Kivu" "Lake Kivu" %}}</li>
        <li>Butare has many universities and cobblestone streets{{% ex "https://maps.app.goo.gl/tJQD9kfn15ojWPet6" %}}</li>
    </ul>
</div>
...
{{% notice tip %}}One of the African Great Lakes{{% ex "https://maps.app.goo.gl/sU2kpL1uezPnfFvs8" "https://maps.app.goo.gl/ZcYG1qAoUR63Mf867" %}}.
{{% /notice %}}
...
{{% notice tip %}}Street names often start with SH{{% ex "https://maps.app.goo.gl/qhcjmQXN7Wb1kuqe6" "https://maps.app.goo.gl/Amr7HGzNQomLgPWQ7" %}}?
{{% /notice %}}
