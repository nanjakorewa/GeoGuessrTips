...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        ...
        <li>Domain adalah <span class="quiz">.tz</span> karena termasuk dalam Republik Bersatu Tanzania</li>
        <li>Plat nomor kendaraan berwarna <span class="quiz">merah</span></li>
        <li>Terdapat banyak mobil Jepang</li>
    </ul>
</div>
...
{{% tab "w-etf" %}}
{{% notice tip %}}
Jika terdapat banyak mobil Jepang dengan plat nomor berwarna <span class="quiz">merah</span>, kemungkinan besar berada di sekitar Zanzibar.
{{% /notice %}}
...
{{% /tab %}}
{{% tab "Kawasan Perkotaan" %}}
{{% notice tip %}}
Wilayah pesisir memiliki mayoritas penduduk Muslim, meskipun terdapat banyak penganut agama lain seperti Kristen.
{{% /notice %}}
<div class="googlemap-if">
