...
{{% tab "w-etf" %}}
{{% notice tip %}}
ボラードや標識を見つけたらそれが頭文字の島に行く{{% ex "https://maps.app.goo.gl/qivNfGk11bW9kK6K7" "https://maps.app.goo.gl/h1ULX2YJry3J3WKX9" %}}。
{{% /notice %}}
...
{{% /notice %}}
<div class="googlemap-if no-margin">
<img src="./rock_mountain_road_cliff.jpg" width="610px">
