...
<img src="/rule/africa/canary_islands/village_icod_de_los.jpg" width="607px" alt="Canary Islands GeoGuessr guide image showing Village Icod De Los">
</div>
...
{{% /notice %}}
<div class="googlemap-if no-margin">
<img src="/rule/africa/canary_islands/lanzarote_canary_islands_landscape_0.jpg" width="640" alt="Canary Islands GeoGuessr guide image showing Lanzarote Canary Islands Landscape 0">
</div>
...
{{% /notice %}}
<div class="googlemap-if no-margin">
<img src="/rule/africa/canary_islands/agave_salmiana_san_francisco.jpg" width="90%" alt="Canary Islands GeoGuessr guide image showing Agave Salmiana San Francisco">
</div>
{{% /tab %}}
{{% tab "w-bollard" %}}
...
{{% tab "Caleta de Sebo" %}}
<div class="googlemap-if no-margin">
<img src="/rule/africa/canary_islands/isla_de_la_graciosa.jpg" width="95%" alt="Canary Islands GeoGuessr guide image showing Isla De La Graciosa">
</div>
{{% /tab %}}
{{% /tabs %}}
