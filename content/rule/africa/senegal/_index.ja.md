...
By BasilLeaf - Own work, CC0, <a href="https://commons.wikimedia.org/w/index.php?curid=112447343">Wikimedia Commons(Link)M</a>
{{% /lb %}}

{{% notice tip %}}
フランスにある電柱とおなじ形の電柱がある。また通り名のプレートもフランスと似たような形のものを使っていて通り名に「RUE」と書かれている。1960年にフランスから独立するまではフランス植民地だった。
{{% /notice %}}
<div class="googlemap-if">
...
{{% notice tip %}}
空に亀裂がある時やGoogle Carの屋根が見えることが多い。
{{% /notice %}}
<div class="googlemap-if">
...
{{% twitter "1623870232921092097" %}}

<img src="2023-04-14-15-23-25.png" style="max-width: 80%;" />

{{% /tab %}}
{{% tab "🥜" %}}
{{% notice tip %}}
道端に火を燃やしたあとが多いので調べてみたところ、ピーナッツを焼いて食べることが多いらしい。ただし道端にある燃やした跡がピーナッツによるものかは不明{{% ref "https://iihanashik.exblog.jp/28377472/" "落花生の脱穀 in Senegal" %}}
{{% /notice %}}
...
<img src="2023-05-13-15-20-11.png" width="90%">
</div>
