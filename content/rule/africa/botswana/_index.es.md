...
jetro_detail: false
plonkit: true
sc_title: "Páginas fáciles de confundir"
sc_icon: rel
sc: [
...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        ...
        <li>La mayoría de las matrículas son de color amarillo, azul y blanco</li>
        <li>Los números de las carreteras comienzan con la letra "<span class="quiz">A</span>" o "<span class="quiz">B</span>"</li>
        <li>Muchas señales y barandillas tienen franjas de colores <span class="quiz">amarillo y negro</span></li>
        <li>Las carreteras tienen superficies rugosas, con arcén de color <span class="quiz">naranja</span>, aunque en algunos lugares no hay arcén</li>
        <li class="no-evidence">El 70% del país está cubierto por el desierto de Kalahari, y todo el territorio es plano</li>
        <li class="no-evidence">Algunas señales antiguas tienen un fondo de color <span class="quiz">azul</span></li>
    </ul>
...
{{% notice tip %}}
Botsuana alberga el desierto de Kalahari, ofreciendo paisajes planos y amplios. En la mayoría de las áreas, se extienden arbustos dispersos y pastos. En las carreteras pavimentadas, hay pocos árboles a los lados {{% ex "https://maps.app.goo.gl/gR9ALGNrNKVTfJZY9" "https://maps.app.goo.gl/Ln49sP8VrhzCwLVr9" %}}.
{{% /notice %}}
<div class="googlemap-if no-margin">
...
{{% notice tip %}}
Los números de las carreteras comienzan con las letras "<span class="quiz">A</span>" o "B". {{% goto "../lesotho/" "Lesoto" %}} también usa una nomenclatura similar, pero a diferencia de Botsuana, Lesoto tiene un terreno montañoso. En Botsuana, las carreteras son escasas, lo que significa que encontrar una señal y una intersección puede facilitar la navegación con precisión.
{{% /notice %}}
...
<div class="main-desciption area-description">
    ...
    <ul class="rule-list">
        <li class="no-evidence">El clima varía en un gradiente: en el norte es tropical, mientras que en el resto del país es un clima de desierto interior. Parece que, al ir hacia el norte, aumentan las hierbas no punzantes y las plantas altas.</li>
    </ul>
</div>
