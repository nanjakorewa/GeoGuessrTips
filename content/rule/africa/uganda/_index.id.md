...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        ...
        <li>Domain negara: <span class="quiz">.ug</span></li>
        <li>Plat nomor kendaraan berwarna <span class="quiz">kuning besar</span> di bagian belakang</li>
        <li class="no-evidence">Rumah biasanya terbuat dari kayu dan bata dengan tirai di pintu</li>
        <li class="no-evidence">Terdapat tanda 笘 pada tiang listrik</li>
        <li>Mobil Google memiliki fitur yang khas</li>
    </ul>
</div>
...
<img src="/rule/africa/uganda/640px-Boda-Boda-Uganda.jpg" width="600px" alt="Uganda GeoGuessr guide image showing 640px Boda Boda Uganda">
</div>
...
<img src="/rule/africa/uganda/640px-Taxis_in_Kampala.jpg" width="600px" alt="Uganda GeoGuessr guide image showing 640px Taxis In Kampala">
</div>
...
{{% /notice %}}
<div class="googlemap-if">
<img src="/rule/africa/uganda/house.jpg" width="600px" alt="Uganda GeoGuessr guide image showing House">
</div>

{{% notice tip %}}
Sering terlihat mobil putih{{% ex "https://maps.app.goo.gl/hggDiqcw488CZ2D89" "https://maps.app.goo.gl/Pp8s4sAmcyPwSRom6" %}} atau palang logam di atap mobil. Palang logam ini biasanya terlihat di luar ibu kota (seperti di taman nasional).
{{% /notice %}}
<div class="googlemap-if">
...
{{% notice tip %}}
Terdapat tanda 笘 pada tiang listrik.
{{% /notice %}}
<div class="googlemap-if">
...
{{% /notice %}}
<div class="googlemap-if">
<img src="/rule/africa/uganda/euphorbia_ingens_zimbabwe.jpg" alt="Uganda GeoGuessr guide image showing Euphorbia Ingens Zimbabwe">
</div>
