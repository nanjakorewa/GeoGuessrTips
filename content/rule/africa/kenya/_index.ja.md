...
{{% tab "w-etf" %}}
{{% notice tip %}}
車は<span class="quiz">左側</span>通行であり、車の後ろナンバーが<span class="quiz">大き目の黄色</span>{{% ex "https://maps.app.goo.gl/sr2UU8U2UUZXNRwL9" "https://maps.app.goo.gl/eZFd7HH9zsEZjw956" "https://maps.app.goo.gl/8icpzm6jeKQFk2MK9" "https://maps.app.goo.gl/59D3a5zrycuc64sv9" "https://goo.gl/maps/ThbKzSX5DNMFNpaR8" %}}。バイクも<span class="quiz">大き目の黄色</span>{{% ex "https://maps.app.goo.gl/RzyrkmBq96HF1Mkb9" %}}。
{{% /notice %}}
