...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        ...
        <li>Pelat nomor belakang kendaraan berwarna <span class="quiz">kuning besar</span></li>
        <li>Domain internet menggunakan <span class="quiz">.ke</span></li>
        <li>Bahasa yang digunakan adalah <span class="quiz">Inggris</span> dan Swahili</li>
        <li>Rambu lalu lintas mirip dengan {{% goto "../../europe/united-kingdom/" "Inggris" %}}</li>
...
{{% tabs %}}
{{% tab "w-etf" %}}
{{% notice tip %}}Kendaraan melaju di sisi <span class="quiz">kiri</span>, dan pelat nomor belakang berwarna <span class="quiz">kuning besar</span> {{% ex "https://maps.app.goo.gl/nNop8SSnJC7MnnqD9" "https://maps.app.goo.gl/sr2UU8U2UUZXNRwL9" "https://maps.app.goo.gl/eZFd7HH9zsEZjw956" "https://maps.app.goo.gl/8icpzm6jeKQFk2MK9" "https://maps.app.goo.gl/59D3a5zrycuc64sv9" "https://goo.gl/maps/ThbKzSX5DNMFNpaR8" %}}. Sepeda motor biasanya tidak memiliki pelat nomor depan, tetapi pelat belakangnya berwarna <span class="quiz">kuning besar</span> {{% ex "https://maps.app.goo.gl/mghxev8i5t5feqfH8" "https://maps.app.goo.gl/RzyrkmBq96HF1Mkb9" %}}.
{{% /notice %}}
...
{{% notice tip %}}
Menurut JETRO, perusahaan lokal yang besar termasuk STEERS (makanan cepat saji) {{% ex "https://goo.gl/maps/edbjb8SkbTxGjXsg9" %}}, Safaricom (telekomunikasi) {{% ex "https://goo.gl/maps/vQLYCbnaWJSWLxNU8" "https://goo.gl/maps/YaW8mCgZShWcfTo27" %}}, dan Java (merek kopi). Safaricom terutama sering terlihat saat berjalan-jalan {{% ref "https://www.jetro.go.jp/ext_images/_Reports/01/550ee35766919b1d/20160137_09franchise.pdf" "JETRO - Perusahaan di Kenya" %}}.
{{% /notice %}}
...
{{% notice tip %}}
Karena Kenya dulunya merupakan protektorat {{% goto "../../europe/united-kingdom/" "Inggris" %}}, rambu lalu lintas di sini mirip dengan yang ada di Inggris. Namun, rambu jarang terlihat di jalanan kota.
{{% /notice %}}
...
{{% notice tip %}}
Google Car di Kenya memiliki beberapa ciri khas, termasuk atap yang terlihat {{% ex "https://maps.app.goo.gl/7BtwomvBcBZGBWF38" "https://maps.app.goo.gl/BpXBaPvnw6Av77uG6" "https://goo.gl/maps/68CahPSGpjN1gWEP9" %}}, snorkel (aksesori hitam pada kendaraan) {{% ex "https://maps.app.goo.gl/tRTEKWnQCoqNSgw17" "https://maps.app.goo.gl/PzwK9emZPdSg6qGw5" "https://goo.gl/maps/AVG4e4xmBvV2zWWw8" "https://maps.app.goo.gl/ADPLGyswN8q8z9L26" %}}, dan spion {{% ex "https://goo.gl/maps/UinADfvy1qPLJvMZ9" %}}. Kadang, Google Car tidak terlihat sama sekali {{% ex "https://maps.app.goo.gl/ctDApK8V6uDwgxqU6" "https://goo.gl/maps/CKy6drok6MeSJxXD9" "https://goo.gl/maps/8a5dM3zL1fGsVv8o7" "https://goo.gl/maps/rA76vccWSB9YcMYbA" %}}.
{{% /notice %}}
...
<div class="main-desciption area-description">
    ...
    <ul class="rule-list">
        <li>Vegetasi berbeda di setiap wilayah
            <ul>
                <li>Pesisir timur: Banyak pohon kelapa kurus</li>
            </ul>
        </li>
    </ul>
</div>
...
{{% notice tip %}}
Banyak pohon dengan puncak datar ditemukan di wilayah ini.
{{% /notice %}}
{{% /tab %}}
{{% /tabs %}}
