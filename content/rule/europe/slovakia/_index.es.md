...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>El dominio es <span class="quiz">.sk</span></li>
        <li>Los bolardos son los mismos que en la República Checa.<span class="quiz">Dos reflectores en la zona negra.</span></li>
        <li>Hay diferencias entre checo y eslovaco
            <ul>
                <li>"<b>Ø</b>" entonces <span class="quiz">checo</span>・"<b>Ŕ</b>" entonces <span class="quiz">Eslovaquia</span></li>
                <li>"<b>Ľ</b>” es casi Eslovaquia{{% ref "https://ja.wikipedia.org/wiki/%C4%BD" "Ľ" %}}.</li>
            </ul>
        </li>
        <li>Sólo en la República Checa y Eslovaquia se utiliza un tipo de barandilla llamado perfil B fino.{{% by "https://youtu.be/6xmUB66kxcA?t=90" "youtube" "10 More Maps You NEED To Know for Geoguessr by zi8gzag" %}}</li>
        <li>en casa <span class="quiz">rojo o azul</span> en el fondo de <span class="quiz">blanco</span> Si tiene caracteres escritos, podría ser checo.<span class="quiz">blanco</span> en el fondo de <span class="quiz">negro</span> Si está escrito en , lo más probable es que sea Eslovaquia.{{% by "https://youtu.be/D4Po4N-LJSw" "youtube" "15 Geoguessr Tips and Metas That Will Boost Your Scores@zi8gzag" %}}.</li>
        <li>Eslovaquia en su conjunto está influenciada por las montañas Tatra.<span class="quiz">En general montañoso</span></li>
        <li>Existe una disparidad económica entre Bratislava y el resto del mundo, con un PIB per cápita de 26.410 dólares en la República Checa y 21.050 dólares en Eslovaquia en 2021.{{% by "https://www.mofa.go.jp/mofaj/area/slovak/data.html" "web" "Ministerio de Asuntos Exteriores República Eslovaca Datos Básicos" %}}.</li>
    </ul>
...
{{% notice tip %}}
bolardos y barandillas.El bolardo es <span class="quiz">Dos reflectores en la zona negra.</span> Hay una barandilla <span class="quiz">Es angular y tiene un amplio hueco en el medio.</span> Es característico que{{% ex "https://maps.app.goo.gl/EXAxnENat8Ushxhj8" "https://goo.gl/maps/RhrcTQhFEksTA9co6" %}}.bolardos y barandillas{{% goto "../czechia/" "checo" %}}tiene lo mismo.
{{% /notice %}}

<div class="googlemap-if unclickable">
<img src="/rule/europe/slovakia/road.jpg" width="90%" alt="Slovakia GeoGuessr guide image showing Road">
</div>


{{% notice tip %}}
El número de la casa es <span class="quiz">blanco</span> en el fondo de <span class="quiz">negro</span> Si tiene caracteres escritos, lo más probable es que sea Eslovaquia.por otro lado <span class="quiz">rojo o azul</span> en el fondo de <span class="quiz">blanco</span> Si está escrito en , puede que sea República Checa.{{% ex "https://goo.gl/maps/38pCS6p63QMBLC2HA" "https://goo.gl/maps/grNrZEVhiEBurcZH9" %}}{{% by "https://youtu.be/D4Po4N-LJSw" "youtube" "15 Geoguessr Tips and Metas That Will Boost Your Scores@zi8gzag" %}}.No es 100% exacto.
{{% /notice %}}

<div class="googlemap-if unclickable">
<img src="/rule/europe/slovakia/house.jpg" width="90%" alt="Slovakia GeoGuessr guide image showing House">
</div>

{{% notice tip %}}
<span class="quiz">checo</span> Los carteles suelen tener bordes del mismo color que el color de fondo.<span class="quiz">Eslovaquia</span> Hay muchas veces que no hay{{% ref "https://en.wikipedia.org/wiki/Comparison_of_European_road_signs" "Comparison of European road signs" %}}.
la cima es <span class="quiz">checo</span>, el fondo es <span class="quiz">Eslovaquia</span>{{% ex "https://goo.gl/maps/Pav9NKUHbtZ7G9W98" %}}.Sin embargo, existen algunas excepciones, como las señales de entrada a las ciudades.
{{% /notice %}}
...
<div class="googlemap-if no-margin">
    <table class="compare-table">
        <tr>
            <td>Tipos de letreros</td>
            <td>checo</td>
            <td>Eslovaquia</td>
        </tr>
        <tr>
            <td>entrada de la ciudad</td>
        ...
        <tr>
            <td>señal de información vial</td>
        ...
        <tr>
            <td>Ejemplo de imagen de esquina</td>
            <td style="background-color:#413F40;"><img src="/rule/europe/slovakia/corner.jpg" width="100px" alt="Slovakia GeoGuessr guide image showing Corner"></td>
            <td style="background-color:#413F40;"><img src="/rule/europe/slovakia/corner2.jpg" width="100px" alt="Slovakia GeoGuessr guide image showing corner2"></td>
        </tr>
    </table>
</div>
...
{{% notice tip %}}
{{% goto "../czechia/" "checo" %}}En las zonas llanas de Eslovaquia se pueden ver calles arboladas como ésta.{{% ex "https://goo.gl/maps/6hymKRijkvboMRaq7" %}}.A veces solo de un lado{{% ex "https://goo.gl/maps/MeoR99KZkJBwU8Hn6" "https://goo.gl/maps/wTeST8grYsbvRq8v9" %}}.
{{% /notice %}}

<div class="googlemap-if">
<a data-flickr-embed="true" href="https://www.flickr.com/photos/jdavis-photos/1429428634/" title="SlovakiaByBike-113"><img src="https://live.staticflickr.com/1333/1429428634_7db3f2c32a_z.jpg" width="640" height="427" alt="Image from live.staticflickr.com showing 1429428634 7db3f2c32a Z"/></a><script async src="//embedr.flickr.com/assets/client-code.js" charset="utf-8"></script>
</div>

{{% notice tip %}}
Eslovaquia utiliza a veces fuentes muy gruesas en algunos de sus carteles circulares.{{% ex "https://maps.app.goo.gl/3rnZtXfbDsUmvFge9" "https://maps.app.goo.gl/QDsGzdv2kPadoHAG9" %}}
{{% /notice %}}
...
{{% notice info %}}
Igual que República Checa{{% goto "../czechia/" "checo" %}}Por favor consulte
{{% /notice %}}
...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>Hay autobuses y postes probablemente del mismo color que la bandera de la ciudad.
            <ul>
                <li class="no-evidence">Košice tiene un autobús.<span class="quiz">amarillo y azul claro</span></li>
                <li class="no-evidence">¿Tiene la impresión de que el color es más cercano al rojo hacia el oeste y más cercano al azul claro hacia el este?</li>
            </ul>
        </li>
    </ul>
</div>
...
{{% tab "Bratislava" %}}
{{% notice tip %}}
En general hay muchos autobuses rojos.También había postes rojos y amarillos, pero no he confirmado si están en otras zonas.
{{% /notice %}}
<div class="googlemap-if">
<a data-flickr-embed="true" href="https://www.flickr.com/photos/129661548@N06/42080443314/in/photolist-277vgJJ-25rTQWQ-Hgy94w-L4Xieh-25pjgei-25rTQSm-JxZpLi-27CjCAf-277vgAC-JxZomp-JxZpzg-JxZoJ8-28HR2PP-JxZoiP-JxZoeF-FK5HvV-277vh4w-JxZpfZ-25rTS3h-L4Xhm5-28DpAvY-28HR2Hr-25rTRjJ-277vguA-JxZpvi-Hgy9pG-JxZpBR-27CjCEU-JxZpte-277vgTm-JxZpmk-27CjCBN-27kXmFi-JxZp22-L4Xi2U-277vhbf-JxZpf8-JxZpRP-JxZpH2-28HR2Ka-JxZp8z-28HR2Ng-25rTQU5-JxZp4g-JxZoPZ-eyxtbn-eeeAVp-eekizu-eLeh2G-eek4id" title="SOR NB18, #2246, DP Bratislava"><img src="https://live.staticflickr.com/880/42080443314_5a2bfcdfd9_z.jpg" width="640" height="480" alt="Image from live.staticflickr.com showing 42080443314 5a2bfcdfd9 Z"/></a><script async src="//embedr.flickr.com/assets/client-code.js" charset="utf-8"></script>
</div>

<div class="googlemap-if unclickable">
<img src="/rule/europe/slovakia/cityflag/Coat_of_Arms_of_Bratislava.svg" width="200px" alt="Cityflag GeoGuessr guide image showing Coat Of Arms Of Bratislava">
</div>
{{% /tab %}}
{{% tab "Žilina" %}}
{{% notice tip %}}
todo amarillo y verde
{{% /notice %}}
<div class="googlemap-if">
...
<div class="googlemap-if unclickable">
<img src="/rule/europe/slovakia/cityflag/Coat_of_Arms_of_Žilina.svg" width="40%" alt="Cityflag GeoGuessr guide image showing Coat Of Arms Of Žilina">
</div>
{{% /tab %}}
{{% tab "Nitra" %}}
{{% notice tip %}}
...
<div class="googlemap-if unclickable">
<img src="/rule/europe/slovakia/cityflag/Coat_of_Arms_of_Nitra.svg" width="40%" alt="Cityflag GeoGuessr guide image showing Coat Of Arms Of Nitra">
</div>
{{% /tab %}}
{{% tab "Košice" %}}
{{% notice tip %}}
Es todo amarillo y azul, pero Paul parecía tener muchos colores iguales en los pueblos de los alrededores.
{{% /notice %}}
<div class="googlemap-if">
...
<div class="googlemap-if unclickable">
<img src="/rule/europe/slovakia/cityflag/Flag_of_Košice.png" width="40%" alt="Cityflag GeoGuessr guide image showing Flag Of Košice">
</div>
{{% /tab %}}
{{% tab "Banská Bystrica" %}}
{{% notice tip %}}
...
<div class="googlemap-if unclickable">
<img src="/rule/europe/slovakia/cityflag/Coat_of_Arms_of_Banská_Bystrica.svg" width="40%" alt="Cityflag GeoGuessr guide image showing Coat Of Arms Of Banská Bystrica">
</div>
{{% /tab %}}
{{% /tabs  %}}