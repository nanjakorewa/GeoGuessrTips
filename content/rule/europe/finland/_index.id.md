...
<div class="googlemap-if">
    <div class="googlemap-if" style="max-width:200px !important;background-color:#eee; padding:25px 20px 0 20px;margin: 10px;border-radius:20px;">
        <div class="googlemap-if unclickable">
            <img src="https://geopinning.space/rule/europe/sweden/r/Sweden_road_sign_F5.svg" alt="Image from geopinning.space showing Sweden Road Sign F5">
            <img src="https://geopinning.space/rule/europe/sweden/r/Swedish_road_sign_1_5_2_15.svg" style="margin-bottom:0; padding-bottom:0" alt="Image from geopinning.space showing Swedish Road Sign 1 5 2 15">
        </div>
        <p><span class="quiz">Swedia</span></p>
    </div>
    <div class="googlemap-if" style="max-width:200px !important;background-color:#eee; padding:25px 20px 0 20px;margin: 10px;border-radius:20px;">
        <div class="googlemap-if unclickable">
            <img src="https://geopinning.space/rule/europe/finland/r/Paikalliskohteen_viitta_648.svg" alt="Image from geopinning.space showing Paikalliskohteen Viitta 648">
            <img src="https://geopinning.space/rule/europe/finland/r/Moottori-_ja_moottoriliikennetien_viitta_649.svg" style="margin-bottom:0; padding-bottom:0" alt="Image from geopinning.space showing Moottori Ja Moottoriliikennetien Viitta 649">
        </div>
        <p><span class="quiz">Finlandia</span></p>
    </div>
    <div class="googlemap-if" style="max-width:200px !important;background-color:#eee; padding:25px 20px 0 20px;margin: 10px;border-radius:20px;">
        <div class="googlemap-if unclickable">
            <img src="https://geopinning.space/rule/europe/norway/r/1920px-Norwegian-road-sign-713.png" style="margin-bottom:0; padding-bottom:0" alt="Image from geopinning.space showing 1920px Norwegian Road Sign 713">
        </div>
...
<img src="https://geopinning.space/rule/europe/finland/r/Finland_road_sign_E1-1.svg" class="margin-ten-px width150" alt="Image from geopinning.space showing Finland Road Sign E1 1" />
<img src="https://geopinning.space/rule/europe/norway/r/NO_road_sign_516.H.svg" class="margin-ten-px width150" alt="Image from geopinning.space showing No Road Sign 516.H" />
<img src="https://geopinning.space/rule/europe/sweden/r/Sweden_road_sign_B3-1.svg" class="margin-ten-px width150" alt="Image from geopinning.space showing Sweden Road Sign B3 1" />
</div>
...
<div class="googlemap-if unclickable">
<img src="/rule/europe/finland/streetsign.jpg" width="95%" alt="Finland GeoGuessr guide image showing Streetsign">
</div>
...
<img src="https://geopinning.space/rule/europe/finland/r/Finland_road_sign_A15.svg" class="width150 margin-ten-px" alt="Image from geopinning.space showing Finland Road Sign A15" />
<img src="https://geopinning.space/rule/europe/finland/r/Finland_road_sign_B5.svg" class="width150 margin-ten-px" alt="Image from geopinning.space showing Finland Road Sign B5" />
<img src="https://geopinning.space/rule/europe/finland/r/Finland_road_sign_C32-60.svg" class="width150 margin-ten-px" alt="Image from geopinning.space showing Finland Road Sign C32 60" />
</div>

<div class="googlemap-if unclickable" style="background-color:#222; padding-top:35px;margin-bottom:0;;border-radius:20px;">
<img src="/rule/europe/finland/Sweden_road_sign_B1.svg" class="width150 margin-ten-px" alt="Finland GeoGuessr guide image showing Sweden Road Sign B1" />
<img src="/rule/europe/finland/Sweden_road_sign_C31-10.svg" class="width150 margin-ten-px" alt="Finland GeoGuessr guide image showing Sweden Road Sign C31 10" />
<img src="/rule/europe/finland/NO_road_sign_362.100.svg" class="width150 margin-ten-px" alt="Finland GeoGuessr guide image showing No Road Sign 362.100" />
</div>
...
{{% /notice %}}
<div class="googlemap-if unclickable" style="background-color:#222; padding-top:25px;margin-bottom:0;;border-radius:20px;">
<img src="https://geopinning.space/rule/europe/finland/p/Finland_road_sign_E5.svg" class="width150 margin-ten-px" alt="Image from geopinning.space showing Finland Road Sign E5" />
<img src="https://geopinning.space/rule/europe/finland/p/Sweden_road_sign_E18.svg" class="width150 margin-ten-px" alt="Image from geopinning.space showing Sweden Road Sign E18" />
<img src="https://geopinning.space/rule/europe/finland/p/NO_road_sign_524.svg" class="width150 margin-ten-px" alt="Image from geopinning.space showing No Road Sign 524" />
</div>
...
<div class="googlemap-if unclickable">
<img src="https://geopinning.space/rule/europe/sweden/road.png" width="90%" style="transform: rotate(180deg);filter: saturate(70%);" alt="Image from geopinning.space showing Road">
</div>

<div class="googlemap-if unclickable no-margin">
<img src="/rule/europe/finland/road.png" width="90%" alt="Finland GeoGuessr guide image showing Road" />
</div>
...
<div class="googlemap-if unclickable no-margin">
<img src="/rule/europe/finland/nature_finnish_finnish_landscape.jpg" width="90%" alt="Finland GeoGuessr guide image showing Nature Finnish Finnish Landscape" />
</div>
...
<div class="googlemap-if unclickable">
<img src="/rule/europe/finland/2023-06-17-13-12-50.png" width="570px" alt="Finland GeoGuessr guide image showing 2023 06 17 13 12 50" />
</div>
...
<div class="googlemap-if unclickable">
<p><img src="/rule/europe/finland/Finland.telephone.areacodes.svg" alt="Finland GeoGuessr guide image showing Finland.telephone.areacodes" width="60%"></p>
<p>Public domain</p>
</div>
