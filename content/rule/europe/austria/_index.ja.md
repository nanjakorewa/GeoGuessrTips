...
{{% tab "w-etf" %}}
{{% notice tip %}}
<span class="quiz">EINBAHN</span>の標識があり{{% ex "https://goo.gl/maps/Tk9wTitkT15y5wvy7" "https://goo.gl/maps/kwHeeyruGhB5nGbr7" %}}ポールに赤と白のペイントがされていることがある。またANFANGと書かれた看板がある{{% ex "https://goo.gl/maps/ougJbaAVvy3rNCr18" "https://goo.gl/maps/ZajkmfdXc85JZzFDA" %}}。
{{% /notice %}}
