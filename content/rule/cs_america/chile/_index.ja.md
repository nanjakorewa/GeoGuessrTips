...
{{% notice tip %}}
電柱のへこんでいる領域に区切りがない電柱が多くたまにひとつかふたつ区切りがある{{% ex "https://goo.gl/maps/ef1PhofsKardanT26" %}}。同じような仕切りのない電柱が{{% goto "../../oceania/new-zealand/" "ニュージーランド" %}}{{% ex "https://goo.gl/maps/9891gRKRFrG6nHfS8" %}}や稀に{{% goto "../../africa/south-africa/" "南アフリカ" %}}{{% ex "https://goo.gl/maps/SvLCzi3PdDfoUi6cA" %}}・{{% goto "../../asia/indonesia/" "インドネシア" %}}{{% ex "https://goo.gl/maps/ianqYpvxMUzSkWv36" %}}にもあるけれど、これらは左側通行で景色も大きく異なるので間違える心配は少ないはず。
{{% /notice %}}
