...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>El dominio es <span class="quiz">.cx</span></li>
        <li>Es común encontrar matrículas <span class="quiz">amarillas</span></li>
        <li>Millones de cangrejos rojos de Navidad habitan la isla. Hay señales de advertencia sobre <span class="quiz">cangrejos</span> y estructuras como puentes para facilitar su cruce de las carreteras. Más información en {{% ref "https://ja.wikipedia.org/wiki/%E3%82%AF%E3%83%AA%E3%82%B9%E3%83%9E%E3%82%B9%E3%82%A2%E3%82%AB%E3%82%AC%E3%83%8B" "Cangrejo Rojo de Navidad" %}}.</li>
...
{{% notice tip %}}
Existen señales de advertencia sobre los cangrejos rojos de Navidad. A menudo se construyen puentes para permitirles cruzar las carreteras. Si hay indicios de cangrejos, probablemente estés en esta isla.
{{% /notice %}}
...
{{% notice tip %}}
El coche de Google es distintivo y parece tener algo similar a una plataforma de carga en su parte trasera.
{{% /notice %}}
<div class="googlemap-if">
