...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>Intersection name signs often use a dark brown background.</li>
    </ul>
    {{% corp "asia/japan" "chubu/yamanashi" %}}
</div>

{{% tabs %}}
{{% tab "Intersection signs" %}}
{{% notice tip %}}
The intersection name boards are tinted dark brown{{% ex "https://maps.app.goo.gl/KLnh5UGHeXpXESBy8" %}}.
{{% /notice %}}
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody class="corp-desc">
            <tr>
                <td>FANUC</td>
                <td>{{% minkabu 6954 %}}</td>
                <td>Holds the world’s number two share in industrial robots and the top share in CNC systems for machine tools.</td>
