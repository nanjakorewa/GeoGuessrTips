...
{{% tab "用心棒" %}}
{{% notice tip %}}
加計呂麻島・宇検村の田検地区には残念ながらストリートビューはないのでGeoGuessrでは使えないヒントだけどおもしろい。
{{% /notice %}}

<div class="googlemap-if">
<blockquote class="twitter-tweet"><p lang="ja" dir="ltr">用心棒。ハブが出たときにこの棒で退治する。奄美大島南部・加計呂麻島などで多く見られる。集落内で約10メートルごとに置かれている。写真は、加計呂麻島阿多地と宇検村田検の用心棒。かつては毎月「巳」の日にノロがハブ除けの祭りをする集落もあった。 <a href="https://t.co/9U7F9iQHGx">pic.twitter.com/9U7F9iQHGx</a></p>&mdash; 現代民俗学 関西学院大学 島村恭則研究室 (@kg_vernacular) <a href="https://twitter.com/kg_vernacular/status/1692785803146215588?ref_src=twsrc%5Etfw">August 19, 2023</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
</div>
