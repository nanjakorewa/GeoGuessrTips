...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        ...
        <li>ナンバープレートはほとんどが<span class="quiz">赤</span>色であり黄色・白色も見かける</li>
...
{{% notice tip %}}ほとんどの車はナンバープレートは<span class="quiz">赤</span>色{{% ex "https://goo.gl/maps/kmaw9QY1Me1gqdY8A" "https://goo.gl/maps/rpLsMoxR38QFk3KN6" "https://goo.gl/maps/LXD1cz2GJuRcpdmP6" %}}。タクシーと思われる車は黄色であることもある{{% ex "https://goo.gl/maps/KHSX735e2gunkdvn9" %}}。
{{% /notice %}}
<div class="googlemap-if">
