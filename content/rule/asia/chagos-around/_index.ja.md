...
{{% notice tip %}}
島によって景色が異なるが海岸に出れば遠くに島が見えることが多い{{% ex "https://goo.gl/maps/ifoG4xFzDd5eouzr8" %}}。ほとんどの島は砂浜が綺麗な白色をしている{{% ex "https://goo.gl/maps/wKrorayXLuiym79W6" %}}。
{{% /notice %}}
...
{{% notice tip %}}
黄緑色の端が丸く反り返った葉っぱの低木が多くの島で生えている気がする{{% ex "https://goo.gl/maps/eZEyPz6qYC4b3MeX6" "https://goo.gl/maps/xPn44HVf4yV4Jzip7" %}}。
{{% /notice %}}
