...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>Domains may also use <span class="quiz">.ru and .su (country code top-level domain for the USSR)</span></li>
        <li>Crosswalk signs have <span class="quiz">three lines</span>.</li>
        <li>The numbers on the signs by the side of the road indicate the distance between the start and end points.</li>
...
{{% notice note %}}
Birch is an important clue because it's easy to see and understand.
{{% /notice %}}
...
{{% /tab %}}
{{% tab "Petasites japonicus" %}}
{{% notice tip %}}
Butterbur grows throughout Japan and in <span class="quiz">Sakhalin</span>.
{{% /notice %}}
...
<div class="main-desciption area-description">
    <ul class="rule-list">
        <li>There is <span class="quiz">blackish fertile soil (chernozem)</span> from Ukraine to southern Siberia, and grain production is flourishing.</li>
        <li>The road has sand on the side in the <span class="quiz">central north</span> provinces of Russia. {{% by "sound_of_silence_wl" "twitch"  %}}</li>
        <li>Astrakhan soil. {{% by "sound_of_silence_wl" "twitch"  %}}</li>
    </ul>
</div>
...
{{% notice tip %}}
It seemed to be blackish, but I don't know if it has any characteristics.
{{% /notice %}}
<div class="googlemap-if">
