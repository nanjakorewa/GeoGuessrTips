...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>Domainnya adalah <span class="quiz">.ru</span>,<span class="quiz">.su</span>(Domain tingkat atas kode negara Uni Soviet)</li>
        <li>Garis tanda penyeberangan <span class="quiz">3 buah</span></li>
        <li>Terdapat papan nama dengan angka tertulis di pinggir jalan, dan angka tersebut mewakili jarak antara titik awal dan titik akhir.</li>
        <li>『<span class="quiz">Ы</span>” “Э” adalah bahasa Rusia{{% goto "../../europe/belarus/" "belarus" %}}Meskipun itu ada dalam kata{{% goto "../../europe/ukraine/" "ukraina" %}}tidak dengan kata-kata</li>
        <li>perusahaan besar Rusia <span class="quiz">Gazprom (Газпром)</span> Ada pompa bensin dan bank di dalamnya</li>
        <li>Pipa sering kali dipasang di atas dinding atau pagar.{{% by "now_and_jenn" "twitch" %}}</li>
        <li>Terdapat banyak tonggak di persimpangan dan persimpangan jalan.{{% by "https://youtu.be/HgPymmvsq8c?t=1941" "youtube" "[GeoGuessr] Penjelasan lengkap tebakan negara oleh pemain resmi!- Daig_O" %}}.</li>
        <li class="no-evidence">Pada akhirnya, Anda perlu mengingat tidak hanya vegetasi tetapi juga distribusi antena Google Car.</li>
    </ul>
...
{{% notice tip %}}
Terdapat banyak tonggak di persimpangan dan persimpangan jalan.{{% ex "https://goo.gl/maps/iThzpuc9huhvD5ux5" %}}{{% by "https://youtu.be/HgPymmvsq8c?t=1941" "youtube" "[GeoGuessr] Penjelasan lengkap tebakan negara oleh pemain resmi!- Daig_O" %}}.
{{% /notice %}}
...
Oleh <a href="//commons.wikimedia.org/w/index.php?title=User:A._L._(loading)&amp;amp;action=edit&amp;amp;redlink=1" class="new" title="User:A. L. (loading) (page does not exist)">AL (memuat)</a> - <span class="int-own-work" lang="en">pekerjaan sendiri</span>, <a href="https://creativecommons.org/licenses/by-sa/4.0" title="Creative Commons Attribution-Share Alike 4.0">CC BY-SA 4.0</a>, <a href="https://commons.wikimedia.org/w/index.php?curid=63893508">Link</a>, Diproses
</div>
...
{{% notice tip %}}
Terdapat tiga jalur penyeberangan dan tanda di pinggir jalan yang menunjukkan jarak.Jarak yang tertulis pada rambu seringkali cukup jauh.
{{% /notice %}}
<div class="googlemap-if">
...
<div class="main-desciption area-description">
    ...
    <ul class="rule-list">
        <li>Perlu dipahami sebaran tumbuhan dan jenis pohon dominan di setiap wilayah.</li>
        <li>Di Sakhalin <span class="quiz">Fuki</span> sering tumbuh{{% by "sound_of_silence_wl" "twitch"  %}}</li>
        <li>Ada dedaunan di sekitar Magadan <span class="quiz">pohon yang mirip jarum</span> ada banyak{{% by "niwaisound" "twitch"  %}}</li>
    </ul>
</div>
...
{{% tab "Larch" %}}
{{% notice tip %}}
Kepadatan larch (area coklat pada gambar di bawah, Larch/Sparse Larch) bervariasi tergantung lokasi.
{{% /notice %}}
...
{{% notice note %}}
Ini merupakan petunjuk penting karena pohon birch putih dan pohon birch putih mudah dilihat.
{{% /notice %}}
...
{{% /tab %}}
{{% tab "Butterbur (Petasites japonicus)" %}}
{{% notice tip %}}
dengan seluruh Jepang <span class="quiz">Karafuto</span> Itu terus berkembang.
{{% /notice %}}
...
{{% tab "Merapikan" %}}
{{% notice tip %}}
Genus pohon cemara melimpah di dekat dan di sebelah barat pegunungan barat laut.
{{% /notice %}}
...
{{% notice tip %}}
Dedaunan menutupi area yang cukup luas di sekitar Magadan.<span class="quiz">pohon yang mirip jarum</span> Terdapat banyak pohon, namun jenis pohon pastinya tidak diketahui.
{{% /notice %}}
<div class="googlemap-if">
...
{{% notice tip %}}
Betula birch konon melimpah di Semenanjung Kamchatka.Jika warna dahannya putih, Anda mungkin bisa membedakannya dari pohon birch, dan jika hitam, Anda mungkin bisa membedakannya dari pohon birch putih.Di sebelah kiri adalah pohon dari Semenanjung Kamchatka, dan di sebelah kanan tampak seperti pohon birch.{{% by "https://tozan-syoshinsya.com/difference-dakekanba-sirakanba/" "web" "Bisakah Anda membedakannya?Perbedaan antara \"Dake birch\" dan \"White birch\" | Pendakian pemula.com" %}}.
{{% /notice %}}
<div class="googlemap-if">
...
<div class="main-desciption area-description">
    <ul class="rule-list">
        <li>Dari Ukraina hingga Siberia selatan <span class="quiz">tanah subur yang gelap (chernozem)</span> ada dan produksi biji-bijian berkembang pesat.</li>
        <li><span class="quiz">Rusia tengah utara</span> Ada pasir yang menumpuk di sepanjang jalan.{{% by "sound_of_silence_wl" "twitch"  %}}</li>
        <li>Tanah Astrakhan unik {{% by "sound_of_silence_wl" "twitch"  %}}</li>
    </ul>
</div>
...
{{% notice tip %}}
Tanah di sekitar Astrakhan berwarna merah dan vegetasinya jarang, sehingga tidak sulit untuk mengidentifikasinya.
{{% /notice %}}
<div class="googlemap-if">
...
{{% notice tip %}}
Saya kira warnanya hitam, tapi saya tidak tahu apakah ada ciri-cirinya.
{{% /notice %}}
<div class="googlemap-if">
...
<div class="main-desciption area-description">
    <ul class="rule-list">
        <li>Semenanjung Kamchatka adalah <span class="quiz">gunung berapi</span> adalah karakteristik{{% by "sound_of_silence_wl" "twitch"  %}}</li>
        <li><span class="quiz">Republik Sakha</span> Ada banyak kabut dan asap.{{% by "sound_of_silence_wl" "twitch"  %}}</li>
        <li><span class="quiz">kemudi kanan jepang</span> Jika proporsi mobil terlalu tinggi, mungkin wilayah tersebut dekat dengan Jepang.{{% by "https://sputniknews.jp/20220912/12882373.html" "web" "Vladivostok, surga mobil bekas Jepang, berubah setelah sanksi terhadap Rusia - Prospek permintaan mobil Jepang dari presiden setempat" %}}?</li>
        <li>Di sebelah timur, Google Car berwarna putih.</li>
        <li>Anda dapat mempersempit wilayah Anda dengan melihat kode area. Dimulai dari arah barat, yang pertama adalah <span class="quiz">4-8-3-4</span>{{% by %}}</li>
    </ul>
</div>

{{% tabs %}}
{{% tab "semenanjung Kamchatka" %}}
...
{{% /tab %}}
{{% tab "mobil penggerak tangan kanan" %}}
...
<div class="main-desciption area-description">
    ...
    <ul class="rule-list">
        <li>『<a href="https://docs.google.com/document/d/1drp1udLAXFNOMDvU0V6pLS2wLakmXujMepTUlkIbc_k/edit#heading=h.xu6byjwpm9nv">Rusia yang Dapat Dipelajari: Panduan Tambahan</a>” sambil membaca “<a href="https://www.geoguessr.com/maps/6447040b0517cbd5807a5145">Rusia yang Dapat Dipelajari</a>{{% ex "https://www.geoguessr.com/maps/6447040b0517cbd5807a5145" %}}” untuk berlatih</li>
    </ul>
</div>
