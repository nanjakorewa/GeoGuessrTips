...
{{% notice tip %}}
路面がコンクリートの時が多い{{% ex "https://goo.gl/maps/ZCYsP4JWnz8kWkpc9" %}}。体感でコンクリートが多いのはフィリピン・{{% goto "../thai/" "タイ" %}}。稀に{{% goto "../indonesia/" "インドネシア" %}}{{% ex "https://goo.gl/maps/hMgA6SCqW8jEe4AM6" %}}や{{% goto "../srilanka/" "スリランカ" %}}の田舎{{% ex "https://goo.gl/maps/h4i8YbRjgNDwqZHh9" %}}。
{{% /notice %}}
