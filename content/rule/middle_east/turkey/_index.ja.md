...
{{% notice tip %}}
ボラードは<span class="quiz">片</span>面に赤い反射板があり薄い{{% ex "https://goo.gl/maps/keFqsE2rFiqDbMvV9" "https://goo.gl/maps/tm5K7Gxt2NE53EpV8" %}}。一番見た目が似ているのは{{% goto "../../europe/romania" "ルーマニア" %}}のボラード{{% ex "https://goo.gl/maps/aTmBGRa3ofVcGowk8" %}}。
{{% /notice %}}
<div class="googlemap-if unclickable">
