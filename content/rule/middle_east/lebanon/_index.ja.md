    ...
    <ul class="rule-list">
        <li>農業に地域性が少しだけある？
            <ul>
                ...
                <li><span style="color:#F7380B;font-size:1.1em">■</span>オリーブ・Tripoli～Bsharri郊外の斜面{{% ex "https://maps.app.goo.gl/eVVSLsBVoYND5ioSA" "https://maps.app.goo.gl/CqkAhvxkm6iS6oKc6" "https://maps.app.goo.gl/7NiFSfWBV466vwKS9" %}}</li>
