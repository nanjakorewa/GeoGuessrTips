...
{{% tabs %}}
{{% tab "w-etf" %}}
{{% notice tip %}}速度制限の表記は<span class="quiz">SPEED LIMIT</span>{{% ex "https://goo.gl/maps/7MDNFYLGn9GgFHDz6" "https://goo.gl/maps/eveAfAJ1gdGddSDj8" "https://goo.gl/maps/8FZ2uBojRTixFCfi9" "https://goo.gl/maps/GJ8DQzv6QrE7Yy2z7" %}}。ただしSPEEDしか書かれていないときは<span class="quiz">オレゴン</span>州。{{% goto "../canada/" "カナダ" %}}は<span class="quiz">MAXIMUM</span>。
{{% /notice %}}
