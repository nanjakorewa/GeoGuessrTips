...
<div class="main-desciption area-description">
    <ul class="rule-list">
        <li>Fuente de los datos: <a href="https://ipad.fas.usda.gov/rssiws/al/europe_cropprod.aspx">Europa - Mapas de Producción de Cultivos - Departamento de Agricultura de los EE. UU. (USDA)</a></li>
        <li>La colza es común en el norte</li>
        <li>El arroz se encuentra principalmente en las zonas costeras del Mediterráneo</li>
        <li>El maíz está ampliamente distribuido, pero es menos común en los países nórdicos y en el Reino Unido</li>
    </ul>
</div>
{{% tabs %}}
{{% tab "Colza" %}}
...
{{% tab "Girasol" %}}
<div class="googlemap-if unclickable">
<img src="2023-05-19-12-35-57.png" width="90%" />
</div>
