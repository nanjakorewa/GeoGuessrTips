...
export const translations: Record<string, Record<Language, string>> = {
  ...
  video_panel_open_pref: {
    ja: "この県の動画を見る",
    en: "Watch videos about this prefecture",
    id: "Tonton video prefektur ini",
    es: "Ver vídeos de esta prefectura",
    pt: "Ver vídeos desta província",
  },
  video_panel_open_area: {
    ja: "この地域の動画を見る",
    en: "Watch videos about this area",
    id: "Tonton video wilayah ini",
    es: "Ver vídeos de esta zona",
    pt: "Ver vídeos desta região",
  },
  video_panel_title: {
    ja: "関連動画",
    en: "Related videos",
    id: "Video terkait",
    es: "Vídeos relacionados",
  ...
  video_panel_open_post: {
    ja: "Instagramで見る",
    en: "View on Instagram",
    id: "Lihat di Instagram",
    es: "Ver en Instagram",
    pt: "Ver no Instagram",
  },
