...
mapProvider: "osm"
mapPins:
  - { lat: 14.634, lng: -90.506, label: "Ciudad de Guatemala", type: "capital", note: "Capital y mayor ciudad de Centroamérica" }
  - { lat: 14.557, lng: -90.733, label: "Antigua Guatemala", type: "historical", note: "Antigua capital y ciudad colonial Patrimonio de la Humanidad" }
  - { lat: 14.836, lng: -91.518, label: "Quetzaltenango", type: "city", note: "Segunda ciudad del país, en el altiplano occidental" }
  - { lat: 17.222, lng: -89.624, label: "Tikal", type: "landmark", note: "Gran sitio maya en la región de Petén, Patrimonio de la Humanidad" }
  - { lat: 14.692, lng: -91.202, label: "Lago de Atitlán", type: "nature", note: "Pintoresco lago de altura rodeado de volcanes" }
  - { lat: 15.471, lng: -89.348, label: "Río Dulce", type: "nature", note: "Cañón y canal de la costa caribeña" }
  - { lat: 14.473, lng: -90.880, label: "Volcán de Fuego", type: "nature", note: "Volcán muy activo de 3.763 m" }
features:
  - text: 'Fue centro de la <span class="quiz">civilización maya</span> y aún conserva yacimientos como Tikal'
