...
mapProvider: "osm"
mapPins:
  - { lat: 18.336, lng: -64.928, label: "Charlotte Amalie", type: "capital", note: "Ibu kota; kota utama di Pulau Saint Thomas" }
  - { lat: 17.742, lng: -64.703, label: "Christiansted", type: "city", note: "Kota utama Pulau Saint Croix; kawasan bersejarah" }
  - { lat: 17.713, lng: -64.881, label: "Frederiksted", type: "city", note: "Kota pelabuhan di barat Pulau Saint Croix" }
  - { lat: 18.331, lng: -64.793, label: "Cruz Bay", type: "city", note: "Pusat Pulau Saint John" }
  - { lat: 18.349, lng: -64.731, label: "Taman Nasional Virgin Islands", type: "nature", note: "Taman nasional yang mencakup sebagian besar Pulau Saint John" }
  - { lat: 18.358, lng: -64.762, label: "Trunk Bay", type: "nature", note: "Pantai dan lokasi snorkel terkenal di dunia" }
features:
  - text: '<span class="quiz">Wilayah tak berinkorporasi AS</span> di Karibia, dengan pulau utama Saint Thomas, Saint Croix, dan Saint John'
  ...
  - text: 'Bekas Hindia Barat Denmark yang dibeli dari Denmark seharga <span class="quiz">25 juta dolar</span> pada tahun 1917'
