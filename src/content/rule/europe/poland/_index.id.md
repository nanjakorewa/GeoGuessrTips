...
mapProvider: "osm"
mapPins:
  - { lat: 52.230, lng: 21.012, label: "Warsawa", type: "capital", note: "Ibu kota, kota tua yang dibangun kembali setelah Perang Dunia II" }
  - { lat: 50.064, lng: 19.945, label: "Krakow", type: "historical", note: "Bekas ibu kota, distrik bersejarah warisan dunia UNESCO" }
  - { lat: 54.352, lng: 18.646, label: "Gdansk", type: "port", note: "Kota bersejarah di pesisir Laut Baltik" }
  - { lat: 51.110, lng: 17.032, label: "Wroclaw", type: "city", note: "Kota utama wilayah Silesia" }
  - { lat: 52.407, lng: 16.925, label: "Poznan", type: "city", note: "Kota utama di wilayah barat" }
  - { lat: 50.034, lng: 19.180, label: "Auschwitz", type: "historical", note: "Bekas kamp konsentrasi, warisan dunia UNESCO" }
  - { lat: 49.299, lng: 19.949, label: "Zakopane", type: "nature", note: "Resor di kaki Pegunungan Tatra" }
features:
  - text: 'Memiliki wilayah terbesar di Eropa Tengah, dengan 14 <span class="quiz">situs warisan dunia</span> termasuk bekas kamp konsentrasi <span class="quiz">Auschwitz</span>'
  ...
  - text: 'Tempat lahir <span class="quiz">Chopin</span>, dan telah melahirkan banyak tokoh besar seperti <span class="quiz">Copernicus</span> dan Madame Curie'
...
related_quizzes: [
    ["/id/quiz/states/europe/poland/", "Kuis tebak provinsi"],
    ["/id/quiz/cities/europe/poland/", "Kuis tebak kota"],
    ]
---
