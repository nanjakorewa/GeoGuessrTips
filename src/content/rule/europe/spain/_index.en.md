...
mapProvider: "osm"
mapPins:
  - { lat: 40.417, lng: -3.704, label: "Madrid", type: "capital", note: "Capital and the country''s political and economic center" }
  - { lat: 41.385, lng: 2.173, label: "Barcelona", type: "city", note: "Capital of Catalonia and Mediterranean port city" }
  - { lat: 37.389, lng: -5.984, label: "Seville", type: "city", note: "Center of the Andalusia region" }
  - { lat: 39.470, lng: -0.376, label: "Valencia", type: "city", note: "Birthplace of paella" }
  - { lat: 41.404, lng: 2.174, label: "Sagrada Família", type: "landmark", note: "Gaudí''s unfinished basilica" }
  - { lat: 37.176, lng: -3.588, label: "Alhambra", type: "landmark", note: "World Heritage Islamic palace" }
  - { lat: 43.263, lng: -2.935, label: "Bilbao", type: "city", note: "Main city of the Basque region" }
features:
  - text: 'A passionate country known for <span class="quiz">flamenco</span> and <span class="quiz">bullfighting</span>, with many original works of architecture such as Gaudí''s <span class="quiz">Sagrada Família</span>'
