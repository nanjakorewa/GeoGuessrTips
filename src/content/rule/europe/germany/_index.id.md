...
mapProvider: "osm"
mapPins:
  - { lat: 52.520, lng: 13.405, label: "Berlin", type: "capital", note: "Ibu kota, simbol reunifikasi Timur-Barat" }
  - { lat: 48.137, lng: 11.575, label: "Munchen", type: "city", note: "Ibu kota negara bagian Bayern, Oktoberfest" }
  - { lat: 53.551, lng: 9.993, label: "Hamburg", type: "port", note: "Kota pelabuhan terbesar di Jerman" }
  - { lat: 50.937, lng: 6.960, label: "Koln", type: "city", note: "Kota bersejarah yang terkenal dengan katedral" }
  - { lat: 50.110, lng: 8.682, label: "Frankfurt", type: "city", note: "Pusat keuangan, lokasi Bank Sentral Eropa" }
  - { lat: 47.557, lng: 10.749, label: "Kastil Neuschwanstein", type: "landmark", note: "Kastil putih milik Ludwig II" }
  - { lat: 51.050, lng: 13.738, label: "Dresden", type: "city", note: "Kota seni di tepi Sungai Elbe" }
features:
  - text: 'Negara dengan ekonomi terbesar di Uni Eropa, terkenal dengan jaringan jalan tolnya termasuk <span class="quiz">Autobahn</span> yang memiliki ruas tanpa batas kecepatan'
...
<div class="main-desciption city-description">
    ...
    <ul class="rule-list">
        ...
        <li class="no-evidence">Sepanjang jalan 'German Timber-Frame Road', terdapat rumah dengan rangka kayu sesuai namanya {{% ref "https://en.wikipedia.org/wiki/German_Timber-Frame_Road" "German Timber-Frame Road" %}}
            <ul>
                <li>Bagian utara {{% ex "https://maps.app.goo.gl/L4oKBRiv6M5yeq6u8" "https://maps.app.goo.gl/i27QV7aWrXFm9peu6" %}}</li>
