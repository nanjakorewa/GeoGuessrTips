...
mapProvider: "osm"
mapPins:
  - { lat: 60.169, lng: 24.938, label: "Helsinki", type: "capital", note: "Capital and major city on the Baltic Sea" }
  - { lat: 60.451, lng: 22.267, label: "Turku", type: "city", note: "Former capital and historic city" }
  - { lat: 61.498, lng: 23.760, label: "Tampere", type: "city", note: "Largest inland city" }
  - { lat: 65.012, lng: 25.471, label: "Oulu", type: "city", note: "Major city in the north" }
  - { lat: 66.504, lng: 25.730, label: "Rovaniemi", type: "city", note: "Center of Lapland and home of Santa Claus Village" }
  - { lat: 60.151, lng: 24.950, label: "Suomenlinna Fortress", type: "landmark", note: "World Heritage sea fortress" }
  - { lat: 61.687, lng: 27.272, label: "Lake Saimaa", type: "nature", note: "Largest lake in the country" }
features:
  - text: 'With about <span class="quiz">188,000</span> lakes, it is called the "<span class="quiz">Land of a Thousand Lakes</span>" and is also the birthplace of the sauna'
...
<img src="/rule/europe/finland/r/Finland_road_sign_A15.svg" class="width150 margin-ten-px" alt="R GeoGuessr guide image showing Finland Road Sign A15" />
<img src="/rule/europe/finland/r/Finland_road_sign_B5.svg" class="width150 margin-ten-px" alt="R GeoGuessr guide image showing Finland Road Sign B5" />
<img src="/rule/europe/finland/r/Finland_road_sign_C32-60.svg" class="width150 margin-ten-px" alt="R GeoGuessr guide image showing Finland Road Sign C32 60" />
</div>
...
{{% /notice %}}
<div class="googlemap-if unclickable" style="background-color:#222; padding-top:25px;margin-bottom:0;;border-radius:20px;">
<img src="/rule/europe/finland/p/Finland_road_sign_E5.svg" class="width150 margin-ten-px" alt="P GeoGuessr guide image showing Finland Road Sign E5" />
<img src="/rule/europe/finland/p/Sweden_road_sign_E18.svg" class="width150 margin-ten-px" alt="P GeoGuessr guide image showing Sweden Road Sign E18" />
<img src="/rule/europe/finland/p/NO_road_sign_524.svg" class="width150 margin-ten-px" alt="P GeoGuessr guide image showing No Road Sign 524" />
</div>
...
<div class="googlemap-if unclickable">
<img src="/rule/europe/sweden/road.png" width="90%" style="transform: rotate(180deg);filter: saturate(70%);" alt="Sweden GeoGuessr guide image showing Road">
</div>
...
<div class="googlemap-if unclickable">
<p><img src="/rule/europe/finland/Finland.telephone.areacodes.svg" alt="Finland GeoGuessr guide image showing Finland.telephone.areacodes" width="60%"></a></p>
<p>public domain</p>
</div>
