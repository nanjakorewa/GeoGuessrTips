...
mapProvider: "osm"
mapPins:
  - { lat: 41.998, lng: 21.426, label: "Skopje", type: "capital", note: "Ibu kota, kota utama negara" }
  - { lat: 41.115, lng: 20.802, label: "Ohrid", type: "historical", note: "Kota tepi danau warisan dunia UNESCO" }
  - { lat: 41.031, lng: 21.334, label: "Bitola", type: "city", note: "Kota utama di selatan" }
  - { lat: 41.745, lng: 22.197, label: "Stip", type: "city", note: "Kota budaya bagian timur" }
  - { lat: 41.130, lng: 20.802, label: "Danau Ohrid", type: "nature", note: "Salah satu danau tertua di Eropa, warisan dunia UNESCO" }
  - { lat: 41.738, lng: 21.711, label: "Veles", type: "city", note: "Kota di tepi Sungai Vardar" }
features:
  - text: 'Negara terkurung daratan yang berganti nama menjadi Republik <span class="quiz">Makedonia Utara</span> pada tahun 2019 setelah perselisihan nama dengan Yunani'
