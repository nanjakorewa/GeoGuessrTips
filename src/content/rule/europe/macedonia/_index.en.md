...
mapProvider: "osm"
mapPins:
  - { lat: 41.998, lng: 21.426, label: "Skopje", type: "capital", note: "Capital and main city of the country" }
  - { lat: 41.115, lng: 20.802, label: "Ohrid", type: "historical", note: "Lakeside World Heritage city" }
  - { lat: 41.031, lng: 21.334, label: "Bitola", type: "city", note: "Major city in the south" }
  - { lat: 41.745, lng: 22.197, label: "Štip", type: "city", note: "Cultural city of the east" }
  - { lat: 41.130, lng: 20.802, label: "Lake Ohrid", type: "nature", note: "One of Europe''s oldest lakes; World Heritage Site" }
  - { lat: 41.738, lng: 21.711, label: "Veles", type: "city", note: "City along the Vardar River" }
features:
  - text: 'A landlocked country that, after a naming dispute with Greece, was renamed the Republic of <span class="quiz">North Macedonia</span> in 2019'
