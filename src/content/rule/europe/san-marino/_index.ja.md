...
{{% notice tip %}}
シェブロンの色がイタリアと異なる{{% ex "https://maps.app.goo.gl/Hn3jAz6Nud4StGTx5" "https://maps.app.goo.gl/RNtnDpyXYEDGgxta6" "https://maps.app.goo.gl/byNZrHFwqwW8urWK6" %}}。サンマリノはオレンジ色で明るく（左）、イタリアは白黒（右）{{% ref "https://www.reddit.com/r/geoguessr/comments/lwa9wr/map_of_european_road_curve_chevron_signs/" "Map of European Road Curve Chevron Signs" %}}。
{{% /notice %}}
...
<div class="googlemap-if unclickable">
<img src="./r/output.jpg" width="144px" style="margin-right:30px" alt="R GeoGuessr guide image showing Output">
<img src="../italy/r/2023-05-14 041948.png" width="140px" style="margin-left:30px" alt="R GeoGuessr guide image showing 2023 05 14 041948">
</div>
...
<div class="googlemap-if unclickable">
<img src="./images.jpg" width="90%" alt="San Marino GeoGuessr guide image showing Images">
</div>
...
{{% /notice %}}
<div class="googlemap-if no-margin">
<img src="subaru_polizia_civile_2.jpg" width="90%" alt="San Marino GeoGuessr guide image showing Subaru Polizia Civile 2">
</div>
{{% lb 50 %}}
