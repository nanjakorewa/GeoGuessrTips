...
mapProvider: "osm"
mapPins:
  - { lat: 41.903, lng: 12.496, label: "Roma", type: "capital", note: "Ibu kota, pusat Kekaisaran Romawi Kuno" }
  - { lat: 45.464, lng: 9.190, label: "Milan", type: "city", note: "Pusat mode dan keuangan" }
  - { lat: 45.440, lng: 12.316, label: "Venesia", type: "city", note: "Kota air, kota kanal" }
  - { lat: 43.770, lng: 11.255, label: "Firenze", type: "city", note: "Tempat lahir Renaisans" }
  - { lat: 40.852, lng: 14.268, label: "Napoli", type: "city", note: "Kota utama di Italia Selatan" }
  - { lat: 43.723, lng: 10.396, label: "Menara Miring Pisa", type: "landmark", note: "Menara miring yang terkenal di dunia" }
  - { lat: 40.821, lng: 14.426, label: "Gunung Vesuvius", type: "nature", note: "Gunung berapi aktif yang mengubur Pompeii" }
features:
  - text: 'Pusat <span class="quiz">Kekaisaran Romawi</span>, dan memiliki situs warisan dunia UNESCO <span class="quiz">terbanyak di dunia</span> dengan 59 situs'
