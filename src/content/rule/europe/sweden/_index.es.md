...
mapProvider: "osm"
mapPins:
  - { lat: 59.329, lng: 18.069, label: "Estocolmo", type: "capital", note: "Capital, Venecia del norte de Europa" }
  - { lat: 57.708, lng: 11.974, label: "Gotemburgo", type: "port", note: "Mayor ciudad portuaria de la costa oeste" }
  - { lat: 55.605, lng: 13.003, label: "Malmö", type: "city", note: "Principal ciudad del sur, junto a Copenhague" }
  - { lat: 59.858, lng: 17.638, label: "Upsala", type: "city", note: "Antigua ciudad universitaria" }
  - { lat: 67.855, lng: 20.225, label: "Kiruna", type: "city", note: "Ciudad minera del Ártico, lugar de observación de auroras" }
  - { lat: 59.323, lng: 17.871, label: "Palacio de Drottningholm", type: "landmark", note: "Patrimonio Mundial, residencia real" }
  - { lat: 57.629, lng: 18.295, label: "Visby", type: "historical", note: "Ciudad medieval de la isla de Gotland" }
features:
  - text: 'Es el mayor país nórdico, cuna de empresas internacionales como <span class="quiz">IKEA</span>, <span class="quiz">Volvo</span> y H&M'
