...
mapProvider: "osm"
mapPins:
  - { lat: 59.329, lng: 18.069, label: "Stockholm", type: "capital", note: "Capital and the Venice of the North" }
  - { lat: 57.708, lng: 11.974, label: "Gothenburg", type: "port", note: "Largest port city on the west coast" }
  - { lat: 55.605, lng: 13.003, label: "Malmö", type: "city", note: "Major city in the south, adjacent to Copenhagen" }
  - { lat: 59.858, lng: 17.638, label: "Uppsala", type: "city", note: "Ancient and university city" }
  - { lat: 67.855, lng: 20.225, label: "Kiruna", type: "city", note: "Arctic mining city and aurora viewing destination" }
  - { lat: 59.323, lng: 17.871, label: "Drottningholm Palace", type: "landmark", note: "World Heritage Site and royal residence" }
  - { lat: 57.629, lng: 18.295, label: "Visby", type: "historical", note: "Medieval city on Gotland Island" }
features:
  - text: 'The largest Nordic country, birthplace of global brands like <span class="quiz">IKEA</span>, <span class="quiz">Volvo</span>, and H&M'
