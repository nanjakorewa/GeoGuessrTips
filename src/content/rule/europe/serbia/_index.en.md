...
mapProvider: "osm"
mapPins:
  - { lat: 44.787, lng: 20.448, label: "Belgrade", type: "capital", note: "Capital at the confluence of the Danube and Sava rivers" }
  - { lat: 45.255, lng: 19.843, label: "Novi Sad", type: "city", note: "Main city of Vojvodina" }
  - { lat: 43.321, lng: 21.896, label: "Niš", type: "city", note: "Major city in the south" }
  - { lat: 43.726, lng: 20.690, label: "Kragujevac", type: "city", note: "Historic city in central Serbia" }
  - { lat: 43.900, lng: 20.349, label: "Žiča Monastery", type: "historical", note: "Coronation site of medieval Serbian kings" }
  - { lat: 43.301, lng: 20.262, label: "Studenica Monastery", type: "landmark", note: "World Heritage Orthodox monastery" }
features:
  - text: 'The home region of <span class="quiz">Nikola Tesla</span>, with the capital <span class="quiz">Belgrade</span> located at the confluence of the Danube and Sava rivers'
