...
mapProvider: "osm"
mapPins:
  - { lat: 35.899, lng: 14.515, label: "Valletta", type: "capital", note: "Capital and World Heritage fortified city" }
  - { lat: 35.895, lng: 14.404, label: "Mdina", type: "historical", note: "Medieval former capital" }
  - { lat: 36.045, lng: 14.241, label: "Victoria", type: "city", note: "Main city of Gozo Island" }
  - { lat: 35.918, lng: 14.490, label: "Sliema", type: "city", note: "Coastal resort city" }
  - { lat: 35.836, lng: 14.546, label: "Marsaxlokk", type: "port", note: "Fishing port in the south" }
  - { lat: 35.939, lng: 14.357, label: "Ħaġar Qim", type: "historical", note: "Megalithic temple; World Heritage Site" }
features:
  - text: 'The smallest EU member state; <span class="quiz">Maltese</span> is the only EU official language with roots in Arabic'
    ref: "https://ja.wikipedia.org/wiki/%E3%83%9E%E3%83%AB%E3%82%BF%E8%AA%9E"
  - text: 'Once the home base of the <span class="quiz">Knights of Malta</span>, and the entire capital <span class="quiz">Valletta</span> is a World Heritage Site'
...
<div class="googlemap-if">
<p><a href="https://commons.wikimedia.org/wiki/File:General_map_of_Malta.svg#/media/File:General_map_of_Malta.svg"><img src="https://upload.wikimedia.org/wikipedia/commons/9/9b/General_map_of_Malta.svg" alt="Wikimedia Commons photo showing General Map Of Malta" height="433" width="502"></a></p><p style="font-size:0.7em"><a href="//commons.wikimedia.org/wiki/File:Location_Malta_EU_Europe.svg">Location_Malta_EU_Europe.svg</a>: <a href="https://en.wikipedia.org/wiki/en:User:3meandEr">User:3meandEr</a>; derivative work: <a href="//commons.wikimedia.org/wiki/User:Trex" title="User:Trex">Trex</a>, <a href="//commons.wikimedia.org/wiki/User:Bjankuloski06en" title="User:Bjankuloski06en">Bjankuloski06en</a> – <a href="https://creativecommons.org/licenses/by-sa/3.0">CC BY-SA 3.0</a>, <a href="https://commons.wikimedia.org/w/index.php?curid=25170149">link</a></p>
</div>
{{% /tab %}}
{{% /tabs %}}
