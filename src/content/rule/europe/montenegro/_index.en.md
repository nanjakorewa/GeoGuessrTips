...
mapProvider: "osm"
mapPins:
  - { lat: 42.441, lng: 19.262, label: "Podgorica", type: "capital", note: "Capital and main city of the country" }
  - { lat: 42.424, lng: 18.770, label: "Kotor", type: "historical", note: "Coastal World Heritage old town" }
  - { lat: 42.291, lng: 18.840, label: "Budva", type: "city", note: "Major resort on the Adriatic" }
  - { lat: 42.787, lng: 19.295, label: "Nikšić", type: "city", note: "Country''s second city" }
  - { lat: 42.385, lng: 18.952, label: "Cetinje", type: "historical", note: "Former capital and center of history and culture" }
  - { lat: 43.354, lng: 19.099, label: "Durmitor National Park", type: "nature", note: "World Heritage mountain region" }
features:
