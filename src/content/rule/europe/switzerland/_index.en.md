...
mapProvider: "osm"
mapPins:
  - { lat: 46.948, lng: 7.447, label: "Bern", type: "capital", note: "Capital with a World Heritage old town" }
  - { lat: 47.376, lng: 8.541, label: "Zurich", type: "city", note: "Financial center and largest city" }
  - { lat: 46.204, lng: 6.143, label: "Geneva", type: "city", note: "Hub of international organizations" }
  - { lat: 47.050, lng: 8.310, label: "Lucerne", type: "city", note: "Lakeside tourist city" }
  - { lat: 45.977, lng: 7.659, label: "Matterhorn", type: "nature", note: "Iconic mountain of the Alps" }
  - { lat: 46.534, lng: 7.962, label: "Jungfraujoch", type: "landmark", note: "Europe''s highest-altitude railway station" }
  - { lat: 47.558, lng: 7.587, label: "Basel", type: "city", note: "Cultural city on the Rhine River" }
features:
  - text: 'A <span class="quiz">permanently neutral country</span> with four official languages: <span class="quiz">German</span>, French, Italian, and Romansh'
...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        ...
        <li class="no-evidence">Are there any flowers that grow at high altitudes?{{% ref "https://nihonkaiplant.shakunage.net/sw/book.html" "Introduction page for \"Plants of the Swiss Alps\"" %}}</li>
    </ul>
</div>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody class="corp-desc">
            ...
            <tr>
                <td>Chubb</td>
                <td>{{% nasdaq CB %}}</td>
                <td>One of the world's largest non-life insurance companies.</td>
