...
mapProvider: "osm"
mapPins:
  - { lat: 46.056, lng: 14.508, label: "Ljubljana", type: "capital", note: "Ibu kota, kota utama negara" }
  - { lat: 46.555, lng: 15.646, label: "Maribor", type: "city", note: "Kota kedua, daerah penghasil anggur" }
  - { lat: 46.369, lng: 14.114, label: "Danau Bled", type: "landmark", note: "Tempat indah yang terkenal dengan gereja di tengah danau" }
  - { lat: 45.776, lng: 14.203, label: "Gua Postojna", type: "nature", note: "Salah satu gua karst terbesar di Eropa" }
  - { lat: 45.546, lng: 13.730, label: "Piran", type: "historical", note: "Kota abad pertengahan di tepi Laut Adriatik" }
  - { lat: 46.222, lng: 13.583, label: "Taman Nasional Triglav", type: "nature", note: "Kawasan konservasi alam Pegunungan Alpen Julian" }
  - { lat: 45.892, lng: 13.730, label: "Gua Skocjan", type: "nature", note: "Gua warisan dunia UNESCO" }
features:
  - text: 'Sekitar <span class="quiz">60%</span> wilayahnya tertutup hutan, dan <span class="quiz">Gua Postojna</span> adalah salah satu gua karst terbesar di Eropa'
