...
municipalities:
  svg: "/maps/countries/portugal.svg"
  title:
    ja: "ポルトガルの県"
    en: "Districts of Portugal"
  list:
    - code: "PT-07"
      name: "エヴォラ県"
      type: "department"
...
related_quizzes: [
    ["/quiz/states/europe/portugal/", "州当てクイズ"],
    ["/quiz/cities/europe/portugal/", "都市当てクイズ"],
    ]
---
...
{{% notice note %}}
黒背景に黄色のシェブロンを見つけたとき、寒そうならば{{% goto "../iceland/" "アイスランド" %}}・<span class="quiz">{{% goto "../ireland/" "アイルランド" %}}・{{% goto "../norway/" "ノルウェー" %}}・{{% goto "../finland/" "フィンランド" %}}</span>を、そうではないならば{{% goto "../luxembourg/" "ルクセンブルグ" %}}を検討してみる{{% ref "https://www.reddit.com/r/geoguessr/comments/lwa9wr/map_of_european_road_curve_chevron_signs/" "Map of European Road Curve Chevron Signs" %}}。アジアっぽいならば{{% goto "../../asia/cambodia/" "カンボジア" %}}の可能性がある{{% ex "https://maps.app.goo.gl/PLpTjrCNeVEpTzZY7" "https://maps.app.goo.gl/X8Y3umxVfEvBPfwC8" %}}。南半球ならば{{% goto "../../cs_america/" "ブラジル" %}}が候補になる。
{{% /notice %}}
