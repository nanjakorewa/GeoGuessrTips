...
mapProvider: "osm"
mapPins:
  - { lat: 53.350, lng: -6.260, label: "Dublin", type: "capital", note: "Ibu kota, tempat lahir bir Guinness" }
  - { lat: 51.898, lng: -8.475, label: "Cork", type: "city", note: "Kota utama di selatan" }
  - { lat: 52.668, lng: -8.630, label: "Limerick", type: "city", note: "Kota bersejarah di tepi Sungai Shannon" }
  - { lat: 53.272, lng: -9.050, label: "Galway", type: "city", note: "Kota budaya di pesisir barat" }
  - { lat: 52.993, lng: -9.428, label: "Tebing Moher", type: "nature", note: "Tebing curam Atlantik, objek wisata" }
  - { lat: 51.770, lng: -10.541, label: "Ring of Kerry", type: "nature", note: "Rute berkendara pemandangan di barat daya" }
  - { lat: 53.391, lng: -6.392, label: "Phoenix Park", type: "nature", note: "Salah satu taman kota terbesar di Eropa" }
features:
  - text: 'Negara hijau yang dijuluki "<span class="quiz">Pulau Zamrud</span>", dan dikenal sebagai tempat lahir <span class="quiz">bir Guinness</span>'
