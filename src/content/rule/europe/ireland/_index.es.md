...
mapProvider: "osm"
mapPins:
  - { lat: 53.350, lng: -6.260, label: "Dublín", type: "capital", note: "Capital, cuna de la cerveza Guinness" }
  - { lat: 51.898, lng: -8.475, label: "Cork", type: "city", note: "Principal ciudad del sur" }
  - { lat: 52.668, lng: -8.630, label: "Limerick", type: "city", note: "Ciudad histórica a orillas del Shannon" }
  - { lat: 53.272, lng: -9.050, label: "Galway", type: "city", note: "Ciudad cultural de la costa oeste" }
  - { lat: 52.993, lng: -9.428, label: "Acantilados de Moher", type: "nature", note: "Acantilados atlánticos, atracción turística" }
  - { lat: 51.770, lng: -10.541, label: "Anillo de Kerry", type: "nature", note: "Ruta panorámica del suroeste" }
  - { lat: 53.391, lng: -6.392, label: "Phoenix Park", type: "nature", note: "Uno de los mayores parques urbanos de Europa" }
features:
  - text: 'Es un país verde y exuberante conocido como la «<span class="quiz">Isla Esmeralda</span>», famoso por ser la cuna de la <span class="quiz">cerveza Guinness</span>'
