...
municipalities:
  svg: "/maps/countries/new-zealand.svg"
  title:
    ja: "ニュージーランドの地方"
    en: "Regions of New Zealand"
  list:
    - { code: "NZ-CIT", name: "Chatham Islands Territory", type: "region" }
    - code: "NZ-STL"
      name: "サウスランド地方"
      type: "region"
      nameI18n:
...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        ...
        <li>ボラードの反射板が<span class="quiz">赤色</span>。色がボラードの<span class="quiz">表裏</span>に塗られているが<span class="quiz">オーストラリア</span>のものは反射板が<span class="quiz">片方だけだったり丸い形だったりする</span>ので区別がつく{{% by "https://www.plonkit.net/new-zealand" "plonkit" %}}。</li>
