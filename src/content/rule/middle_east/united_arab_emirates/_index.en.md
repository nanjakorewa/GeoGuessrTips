...
related_quizzes: [
    ["/en/quiz/cities/middle_east/uae/", "City quiz"],
    ]
---
...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>Country-code top-level domain is <span class="quiz">.ae</span></li>
        <li>License plates are mainly white but may have a <span class="quiz">red strip</span> on the left</li>
        <li>Dubai’s skyline features prominent high-rises</li>
        <li>The Google Car roof is sometimes visible {{% ex "https://maps.app.goo.gl/sKu7Yrz2cNuFYwJu5" %}}</li>
    </ul>
...
{{% notice tip %}}
License plates are mainly white, but a <span class="quiz">red strip</span> may appear on the left. {{% ex "https://maps.app.goo.gl/N5S8s8FunbFnndAS6" %}} Qatar uses similar colours, so confirm with other clues.
{{% /notice %}}
<div class="googlemap-if">
...
{{% notice tip %}}
The Google Car is distinctive—often a white vehicle with the roof visible. Even when the roof isn’t visible, expect a white body.
{{% /notice %}}
<div class="googlemap-if">
...
<div class="main-desciption area-description">
    ...
    <ul class="rule-list">
        <li>On Sir Bani Yas Island the Google Car roof is visible almost everywhere</li>
    </ul>
</div>
...
{{% notice tip %}}
Distinct scenery {{% ex "https://maps.app.goo.gl/nCXUmC1QemMsn7xLA" "https://maps.app.goo.gl/EMdbXXuBST1K4tuB6" %}} and the Google Car appears in nearly every panorama {{% ex "https://maps.app.goo.gl/Ff2XteyYMELFxSdi6" "https://maps.app.goo.gl/kvMPDaL9mb91Fa9S8" %}}.
{{% /notice %}}
