...
<div class="googlemap-if no-margin">
<img src="sign.png" width="300px" alt="Oman GeoGuessr guide image showing Sign">
</div>
...
<div class="googlemap-if no-margin">
<img src="desert_sand_dry_hot.jpg" width="90%" alt="Oman GeoGuessr guide image showing Desert Sand Dry Hot">
</div>
...
<div class="googlemap-if no-margin">
<img src="date_palm_date_palm.jpg" width="90%" alt="Oman GeoGuessr guide image showing Date Palm Date Palm">
</div>
...
<div class="googlemap-if no-margin">
<img src="street_travel_car_mountain.jpg" alt="Oman GeoGuessr guide image showing Street Travel Car Mountain">
</div>
{{% /tab %}}
{{% tab "ドファール山脈" %}}
...
<div class="googlemap-if no-margin">
<img src="after_rain_7.jpg" width="90%" alt="Oman GeoGuessr guide image showing After Rain 7">
</div>
...
<div class="googlemap-if no-margin">
<img src="soilmap.jpg" alt="Oman GeoGuessr guide image showing Soilmap">
</div>
{{% /tab %}}
{{% /tabs  %}}
