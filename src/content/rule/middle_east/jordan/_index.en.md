...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>The domain is <span class="quiz">.jo</span></li>
        <li>Official language is <span class="quiz">Arabic</span></li>
        <li>There are many <span class="quiz">yellow and green</span> cabs in Amman{{% by %}}.</li>
