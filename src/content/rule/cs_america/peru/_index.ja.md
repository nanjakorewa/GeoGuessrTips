...
municipalities:
  svg: "/maps/countries/peru.svg"
  title:
    ja: "ペルーの県"
    en: "Departments of Peru"
  list:
    - code: "PE-TAC"
      name: "タクナ県"
      type: "department"
...
{{% notice tip %}}
ナンバープレート上部に青色以外の色が付いているのはペルーか{{% goto "../ecuador/" "エクアドル" %}}の可能性が高い。バスは<span class="quiz">緑</span>色やオレンジ{{% ex "https://maps.app.goo.gl/HSnmgUQczyK88xxq9" %}}、タクシーとトラックは<span class="quiz">黄色の蛍光</span>色{{% ex "https://goo.gl/maps/iDhgexqddRXEabYS9" "https://goo.gl/maps/AKKV6fvSMryDSJwj7" %}}・{{% ref "https://en.wikipedia.org/wiki/Vehicle_registration_plates_of_Peru" "Vehicle registration plates of Peru" %}}。
{{% /notice %}}

<div class="googlemap-if unclickable no-margin">
<img src="./Ciclovía_Invadida_por_un_taxista.jpg" width="590px" alt="Peru GeoGuessr guide image showing Ciclovía Invadida Por Un Taxista">
</div>
...
<div class="googlemap-if no-margin">
<img src="./pole.jpg" width="95%" alt="Peru GeoGuessr guide image showing Pole">
</div>
...
<div class="googlemap-if no-margin">
<img src="./house.jpg" width="90%" alt="Peru GeoGuessr guide image showing House">
</div>
...
<div class="googlemap-if">
<img src="./paisaje_en_chiquian_bolognesi.jpg" alt="Peru GeoGuessr guide image showing Paisaje En Chiquian Bolognesi">
</div>
...
{{% tab "コメ" %}}
<div class="googlemap-if unclickable no-margin">
<img src="2023-06-18-20-15-15.png" width="500px" alt="Peru GeoGuessr guide image showing 2023 06 18 20 15 15">
</div>
...
{{% notice tip %}}
郊外はかなり独特な景色が広がっている{{% ex "https://maps.app.goo.gl/KhsTptkRrkBAcaMx6" "https://maps.app.goo.gl/j4KJefBfJyd1Eapt5" %}}。
{{% /notice %}}
...
{{% /notice %}}
<div class="googlemap-if no-margin">
<img src="iquitosmoto.jpg" width="90%" alt="Peru GeoGuessr guide image showing Iquitosmoto">
<img src="iron_house_iquitos.jpg" width="90%" alt="Peru GeoGuessr guide image showing Iron House Iquitos">
</div>
...
{{% notice tip %}}
Machu PicchuやAguas Calientes駅付近は山に囲まれている。また特徴的なGoogle Carがはっきりと見えることが多い{{% ex "https://maps.app.goo.gl/F9rHT8umug6Vm4ww9" "https://maps.app.goo.gl/aEZr67pbzKitNBzE8" %}}。歩いて撮影している場所も多い。
{{% /notice %}}

<div class="googlemap-if no-margin">
<img src="./aguas_calientes_2_0.jpg" width="80%" alt="Peru GeoGuessr guide image showing Aguas Calientes 2 0">
<img src="./machu_picchu_peru_inca_6.jpg" width="80%" alt="Peru GeoGuessr guide image showing Machu Picchu Peru Inca 6">
</div>
{{% /tab %}}
{{% /tabs %}}
