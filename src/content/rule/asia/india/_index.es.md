...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>El dominio nacional es <span class="quiz">.in</span></li>
        <li>Conviven numerosas lenguas: <span class="quiz">hindi, inglés y muchos idiomas regionales</span></li>
    </ul>
...
{{% notice tip %}}
Los postes eléctricos tienen formas muy particulares y el cableado suele estar bastante desordenado.
{{% /notice %}}
<div class="googlemap-if">
...
<div class="main-desciption area-description">
    ...
    <ul class="rule-list">
        <li>El color del suelo cambia según la región</li>
    </ul>
</div>


{{% tabs %}}
{{% tab "Distribución del suelo" %}}
{{% notice tip %}}
Los suelos rojizos aparecen en el suroeste y el sur, los tonos oscuros desde Delhi hacia el centro-sur y los suelos claros y sedosos en el norte.
{{% /notice %}}
...
{{% tab "Suelo oscuro" %}}
{{% notice tip %}}
Los suelos negros, conocidos como regur, son ideales para el cultivo de algodón{{% ref "https://en.wikipedia.org/wiki/Major_soil_deposits_of_India" "Major soil deposits of India" %}}.
{{% /notice %}}

<div class="googlemap-if">
<iframe src="https://www.google.com/maps/embed?pb=!4v1682467835049!6m8!1m7!1sAQE1pjOxkCxQGyEeiREzkA!2m2!1d21.83794795470153!2d75.77963971665952!3f170.19765652336443!4f-1.3508235966190135!5f2.8571056679701285" width="295" height="295" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
<iframe src="https://www.google.com/maps/embed?pb=!4v1682467897510!6m8!1m7!1sp8MElAgb9pGw7rY5mHyb1g!2m2!1d23.54090533297471!2d79.00901675549168!3f329.3499161395673!4f-21.340718629230854!5f2.918013455152783" width="295" height="295" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
{{% /tab %}}
{{% tab "Suelo claro" %}}
<div class="googlemap-if">
...
{{% notice tip %}}
La bansuri es una flauta de madera muy utilizada en la música hindustani.
{{% /notice %}}
