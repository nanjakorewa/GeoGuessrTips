...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>The domain is <span class="quiz">.my</span></li>
        <li>Official languages include Malay and English</li>
        <li>Cars drive on the <span class="quiz">left</span></li>
        <li><span class="quiz">Yellow</span> hexagonal route numbers</li>
        <li>Stop signs say <span class="quiz">berhenti</span></li>
        <li>License plates are <span class="quiz">white text on black</span></li>
        <li>If you see a <span class="quiz">black label</span> on utility poles, it is the peninsula{{% by "https://youtu.be/HgPymmvsq8c?t=2551" "youtube" "【GeoGuessr】Country Guide - Daig_O" %}}</li>
...
{{% notice tip %}}
Yellow hexagonal route numbers{{% ex "https://maps.app.goo.gl/ZA6iiKkwtvp2v5hU6" "https://goo.gl/maps/P5b5vY3q5EFt65C87" %}}. The Malaysian Public Works Department logo is also a yellow hexagon and appears on signs{{% ref "https://en.wikipedia.org/wiki/Malaysian_Public_Works_Department" "Jabatan Kerja Raya Malaysia" %}}. Many signs use black-and-white striped poles, and the centerline is usually <span class="quiz">white</span>. Roads with double <span class="quiz">white</span> lines in the center like this are rare outside Malaysia{{% ex "https://maps.app.goo.gl/f9CHkmZN4QXczH6y5" "https://maps.app.goo.gl/5rWj7nAyagkg769y6" %}}.
{{% /notice %}}
...
{{% notice tip %}}Most centerlines are double <span class="quiz">white</span>. Roads like this are almost always Malaysia{{% ex "https://maps.app.goo.gl/f9CHkmZN4QXczH6y5" "https://maps.app.goo.gl/5rWj7nAyagkg769y6" %}}.
{{% /notice %}}

{{% notice note %}}{{% goto "../hongkong/" "Hong Kong" %}}{{% ex "https://maps.app.goo.gl/CifxE4hfJUbCqeFe8" %}} and, very rarely, {{% goto "../indonesia/" "Indonesia" %}} can also show double white lines{{% ex "https://maps.app.goo.gl/5mqzZRn3wroL8jW96" %}}.
{{% /notice %}}
...
{{% notice tip %}}
If you see a <span class="quiz">black label</span> on utility poles, it is the peninsula rather than Borneo{{% ex "https://maps.app.goo.gl/XshWgGgTSTuLbi6K6" "https://goo.gl/maps/YQD7zudhP7gvPQ5Z8" "https://goo.gl/maps/5j7Hzz1tBCcATtng8" "https://goo.gl/maps/okyaq9kLeWMKRu54A" %}}{{% by "https://youtu.be/HgPymmvsq8c?t=2551" "youtube" "【GeoGuessr】Country Guide - Daig_O" %}}. But black-label-like poles in Indonesia’s Riau Islands have misled me before{{% ex "https://goo.gl/maps/orFPcKqtGHpvKZYP7" "https://goo.gl/maps/ojX1sp7TheqCbviM9" %}}, so check the surroundings too.
{{% /notice %}}
...
{{% notice tip %}}
Depending on the mosaic, the license plate may look split into two{{% ex "https://maps.app.goo.gl/MHW3BWN8aorm1hvXA" %}}. If it looks split into three, it might be {{% goto "../indonesia/" "Indonesia" %}}.
{{% /notice %}}
...
{{% notice tip %}}
Asphalt roads are common and concrete roads are rare. Concrete roads usually appear only in remote places such as outlying islands{{% ex "https://goo.gl/maps/mp53Cutjb9t8TXfx7" "https://goo.gl/maps/sEo5nN4GpnKS7YBp8" "https://goo.gl/maps/iwpVBePBdapZv4w56" %}}. Roadside signs and bollards often show place names and route numbers{{% ex "https://goo.gl/maps/DTB8z4GMhRH92Nbe9" %}}.
{{% /notice %}}
...
{{% notice tip %}}
Petronas Gas (PGB), run by the national oil and gas company Petronas, appears on signs with locations{{% ref "https://www.petronas.com/pgb/" "PETRONAS Gas Berhad (PGB)" %}}. The example below is a station in {{% goto "https://goo.gl/maps/uwDiMQXYg3BihAjSA" "Lundu" %}}. Petrona🍆.
{{% /notice %}}
...
{{% notice tip %}}
"AWAS" means caution in Malay{{% ex "https://maps.app.goo.gl/fDAPhVLrP5ar3zf79" "https://maps.app.goo.gl/2rvkZDnezq6N5Etk7" "https://maps.app.goo.gl/w4Yi8siCXuUafbgM8" %}}.
{{% /notice %}}
...
<div class="main-desciption area-description">
    ...
    <ul class="rule-list">
        <li>If you see Jawi script on street names or supermarket signs, it may be the northern or southern peninsula{{% ref "https://en.wikipedia.org/wiki/Jawi_script" "Jawi script" %}}.</li>
...
{{% tab "Jawi script" %}}
{{% notice tip %}}
Common in the northern peninsula (Terengganu, Kelantan, Kedah, Perlis) and the southern peninsula (Johor, the state closest to Singapore). If the sign is yellow, it is likely <span class="quiz">Johor</span>{{% ref "https://docs.google.com/document/d/1BYu38SKT5Gej-jjHZ0cESvmRGPGT1KqaBpRgQa3Ctz0/edit" "The Malaysia Doc by zi8gzag" %}}. Jawi script also appears in Indonesia’s Riau and Riau Islands.
{{% /notice %}}
...
{{% notice tip %}}
Large palm plantations often surround red <span style="color: red;">●</span> palm oil mills. Central Sarawak has few roads, so if you see large plantations, lean toward eastern Sabah.
{{% /notice %}}
...
<div class="main-desciption area-description">
    ...
    <ul class="rule-list">
        <li>There is a resort island called Mabul where you can scuba dive{{% ex "https://goo.gl/maps/RB8M8NmTHae4sWGp9" "https://goo.gl/maps/otfpmTA2xywn9AuA8" %}}</li>
...
{{% tab "Mabul Island" %}}
{{% notice tip %}}
Located at Malaysia’s easternmost area{{% ex "https://goo.gl/maps/RB8M8NmTHae4sWGp9" "https://goo.gl/maps/otfpmTA2xywn9AuA8" %}}.
{{% /notice %}}
...
{{% notice tip %}}
Concrete roads are very rare in Malaysia. Remote areas like islands often have concrete roads. Sloped areas where asphalt cannot be evenly rolled also tend to be concrete. Mountainous Thailand, island-heavy Philippines{{% ex "https://maps.app.goo.gl/siH6NTBD1aNM3XDj8" %}}, and mountainous Colombia{{% ex "https://maps.app.goo.gl/cayVSUSkmX24XTLB8" %}} also have concrete roads.
{{% /notice %}}
