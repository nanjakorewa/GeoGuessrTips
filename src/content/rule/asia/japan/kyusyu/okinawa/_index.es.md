...
mapProvider: "osm"
mapPins:
  - { lat: 26.213, lng: 127.679, label: "Naha", type: "capital", note: "Capital de la Prefectura de Okinawa" }
  - { lat: 26.217, lng: 127.719, label: "Castillo de Shuri", type: "historical", note: "Palacio real del reino de Ryūkyū, Patrimonio Mundial" }
  - { lat: 26.215, lng: 127.687, label: "Kokusai-dōri", type: "city", note: "Avenida comercial de Naha" }
  - { lat: 26.694, lng: 127.878, label: "Acuario Churaumi", type: "landmark", note: "Gran tanque, en la localidad de Motobu" }
  - { lat: 24.339, lng: 124.156, label: "Isla Ishigaki", type: "nature", note: "Centro del archipiélago Yaeyama" }
  - { lat: 24.812, lng: 125.281, label: "Isla Miyako", type: "nature", note: "Hermosas playas" }
  - { lat: 26.870, lng: 128.265, label: "Cabo Hedo", type: "nature", note: "Extremo más septentrional de la isla principal de Okinawa" }
features:
  - text: 'Es la prefectura más meridional de Japón, de clima subtropical y rodeada de un mar de <span class="quiz">arrecifes de coral</span>'
    ref: "https://ja.wikipedia.org/wiki/沖縄県"
  - text: 'Por haber estado bajo administración estadounidense hasta 1972, alberga numerosas <span class="quiz">bases militares estadounidenses</span>'
