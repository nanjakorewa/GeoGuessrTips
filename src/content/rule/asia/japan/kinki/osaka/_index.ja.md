...
features:
  - text: '西日本最大の経済圏で、<span class="quiz">商業・卸売業</span>の中心地として「天下の台所」の伝統を持つ'
...
prefInfo:
  ...
  economy: '西日本最大の経済圏で、商業・卸売の中心として「天下の台所」の歴史。道修町は江戸期からの薬種街で、現在も武田薬品・塩野義・住友ファーマ（旧大日本住友製薬）・田辺三菱の本社が集積する製薬の中心地。堺は刃物（プロ用包丁国内シェア約 9 割）と自転車部品（シマノ本社）。池田に日清食品創業地（インスタントラーメン誕生）。泉州は綿織物・タオル・水なすの伝統産業地。商社（伊藤忠・住友・丸紅・双日のルーツ）と海運（商船三井・川崎汽船のルーツ）も大阪発祥で、大阪本社／関西本社を残す企業も多い。'
  relatedIndustry:
...
<img src="/rule/poles/osaka.png" width="200px" alt="大阪の標識ポール">
</div>
