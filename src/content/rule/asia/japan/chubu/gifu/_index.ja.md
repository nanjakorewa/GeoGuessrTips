...
{{% tab "関" %}}
{{% notice tip %}}
関市は<span class="quiz">刃物</span>の街で、家庭用刃物の出荷額は国内シェア約55%{{% ex "https://maps.app.goo.gl/fttwfbcfDoXP97eSA" %}}{{% ref "https://www.city.seki.lg.jp/cmsfiles/contents/0000004/4761/kogyo_R4.pdf" "関市の工業（令和4年）" %}}。独ゾーリンゲン・英シェフィールドと並ぶ世界三大刃物産地の一つ。
{{% /notice %}}
