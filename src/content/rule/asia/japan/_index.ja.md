...
{{% tab "4県に出現①" %}}
{{% notice tip %}}
<a href="./chubu/nagano/">長野県</a>・<a href="./chubu/aichi/">愛知県</a>・<a href="./chugoku/yamaguchi/">山口県</a>・<a href="./kyusyu/kagoshima/">鹿児島県</a>
{{% /notice %}}

<div class="googlemap-if" style="display:flex;gap:2em;align-items:flex-start;flex-wrap:wrap;">
<img src="diamond-marking-a.svg" width="100px" height="250px" alt="Japan GeoGuessr guide image showing Diamond marking type A">
</div>
