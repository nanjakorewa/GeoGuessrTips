...
{{% lb 50 %}}
![](Azərbaycan_Respublikası_avtomobil_dövlət_qeydiyyat_nişanı_-_Ali_RəHbərlik.svg)
...
{{% notice tip %}}
平べったいシェブロン。ボラードは{{% goto "../kazakhstan/" "キルギスタン" %}}・{{% goto "../../middle_east/turkey/" "トルコ" %}}・{{% goto "../../europe/germany/" "ドイツ" %}}などにありそうなものが写っておりどれが一番多いのかは不明{{% ex "https://commons.wikimedia.org/wiki/Category:Fuzuli-Shusha_highway#/media/File:Victory_Road,_Karabakh,_Azerbaijan_in_November_2021_(14).jpg" "https://commons.wikimedia.org/wiki/Category:Roads_in_Azerbaijan#/media/File:Ismayilli-Qebele_yolu.JPG" %}}。
{{% /notice %}}
