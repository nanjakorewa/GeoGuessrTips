...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        <li>El dominio es <span class="quiz">.ru</span>,<span class="quiz">.su</span>(Código de país de dominio de nivel superior de la Unión Soviética)</li>
        <li>Líneas de señales de paso de peatones <span class="quiz">3 piezas</span></li>
        <li>Hay un letrero con números escritos al costado de la carretera, y los números representan la distancia entre el punto de partida y el punto final.</li>
        <li>『<span class="quiz">Ы</span>“Э” es ruso{{% goto "../../europe/belarus/" "bielorrusia" %}}Aunque está en la palabra{{% goto "../../europe/ukraine/" "Ucrania" %}}no en palabras</li>
        <li>importante empresa rusa <span class="quiz">Gazprom (Газпром)</span> Hay gasolineras y bancos en</li>
        <li>Las tuberías suelen pasar por encima de paredes o vallas.{{% by "now_and_jenn" "twitch" %}}</li>
        <li>Hay muchos bolardos en las intersecciones y cruces de carreteras.{{% by "https://youtu.be/HgPymmvsq8c?t=1941" "youtube" "[GeoGuessr] ¡Explicación completa de las adivinanzas de países por parte de jugadores autorizados!-Daig_O" %}}.</li>
        <li class="no-evidence">Al final, tendrás que recordar no sólo la vegetación sino también la distribución de la antena de Google Car.</li>
    </ul>
...
{{% notice tip %}}
Hay muchos bolardos en las intersecciones y cruces de carreteras.{{% ex "https://goo.gl/maps/iThzpuc9huhvD5ux5" %}}{{% by "https://youtu.be/HgPymmvsq8c?t=1941" "youtube" "[GeoGuessr] ¡Explicación completa de las adivinanzas de países por parte de jugadores autorizados!-Daig_O" %}}.
{{% /notice %}}
...
Por <a href="//commons.wikimedia.org/w/index.php?title=User:A._L._(loading)&amp;amp;action=edit&amp;amp;redlink=1" class="new" title="User:A. L. (loading) (page does not exist)">AL (cargando)</a> - <span class="int-own-work" lang="en">propio trabajo</span>, <a href="https://creativecommons.org/licenses/by-sa/4.0" title="Creative Commons Attribution-Share Alike 4.0">CC BY-SA 4.0</a>, <a href="https://commons.wikimedia.org/w/index.php?curid=63893508">Enlace</a>, Procesado
</div>
...
{{% notice tip %}}
Hay tres líneas de paso de peatones y un cartel al costado de la carretera que indica la distancia.Las distancias escritas en las señales suelen ser bastante largas.
{{% /notice %}}
<div class="googlemap-if">
...
{{% tab "w-building" %}}
{{% notice tip %}}
tubería a lo largo de la cerca
{{% /notice %}}
...
<div class="main-desciption area-description">
    ...
    <ul class="rule-list">
        <li>Es necesario comprender la distribución de plantas y especies de árboles dominantes en cada región.</li>
        <li>En Sajalín <span class="quiz">Fuki</span> a menudo crece{{% by "sound_of_silence_wl" "twitch"  %}}</li>
        <li>Hay hojas alrededor de Magadán.<span class="quiz">árbol con forma de aguja</span> hay muchos{{% by "niwaisound" "twitch"  %}}</li>
    </ul>
</div>
...
{{% tab "Alerce" %}}
{{% notice tip %}}
La densidad del alerce (área marrón en la figura siguiente, Alerce/Alerce disperso) varía según la ubicación.
{{% /notice %}}
...
{{% /tab %}}
{{% tab "Abedul/álamo temblón" %}}

{{% notice note %}}
Esta es una pista importante porque el abedul blanco y el abedul blanco son fáciles de ver.
{{% /notice %}}
...
{{% /tab %}}
{{% tab "Petasita (Petasites japonicus)" %}}
{{% notice tip %}}
con todo japon <span class="quiz">Karafuto</span> Sigue creciendo.
{{% /notice %}}
...
{{% tab "Picea" %}}
{{% notice tip %}}
El género de abeto abunda cerca y al oeste de la cordillera del noroeste.
{{% /notice %}}
...
{{% notice tip %}}
Las hojas cubren un área bastante amplia alrededor de Magadan.<span class="quiz">árbol con forma de aguja</span> Hay muchos árboles, pero se desconoce el tipo exacto de árbol.
{{% /notice %}}
<div class="googlemap-if">
...
{{% notice tip %}}
Se dice que el abedul Betula abunda en la península de Kamchatka.Si el color de las ramas es blanco, es posible que puedas distinguirlo de un abedul, y si es negro, es posible que puedas distinguirlo de un abedul blanco.A la izquierda hay un árbol de la península de Kamchatka y a la derecha lo que parece ser un abedul.{{% by "https://tozan-syoshinsya.com/difference-dakekanba-sirakanba/" "web" "¿Puedes notar la diferencia?Diferencia entre \"Abedul Dake\" y \"Abedul blanco\" | Principiantes de escalada.com" %}}.
{{% /notice %}}
<div class="googlemap-if">
...
<div class="main-desciption area-description">
    <ul class="rule-list">
        <li>De Ucrania al sur de Siberia <span class="quiz">suelo fértil oscuro (chernozem)</span> Existía y la producción de cereales florecía.</li>
        <li><span class="quiz">Rusia central norte</span> Hay arena amontonada a lo largo del camino.{{% by "sound_of_silence_wl" "twitch"  %}}</li>
        <li>El suelo de Astracán es único. {{% by "sound_of_silence_wl" "twitch"  %}}</li>
    </ul>
</div>
...
{{% notice tip %}}
El suelo alrededor de Astracán es rojo y la vegetación es escasa, por lo que no es difícil identificarlo.
{{% /notice %}}
<div class="googlemap-if">
...
{{% notice tip %}}
Pensé que era negro, pero no sé si tiene alguna característica.
{{% /notice %}}
<div class="googlemap-if">
...
<div class="main-desciption area-description">
    <ul class="rule-list">
        <li>La península de Kamchatka es <span class="quiz">volcán</span> es caracteristico{{% by "sound_of_silence_wl" "twitch"  %}}</li>
        <li><span class="quiz">República de Sajá</span> Hay mucha niebla y humo.{{% by "sound_of_silence_wl" "twitch"  %}}</li>
        <li><span class="quiz">volante a la derecha japón</span> Si la proporción de automóviles es demasiado alta, podría ser una zona cercana a Japón.{{% by "https://sputniknews.jp/20220912/12882373.html" "web" "Vladivostok, el paraíso de los coches usados ​​en Japón, cambia tras las sanciones contra Rusia - Perspectivas de la demanda de coches japoneses de un presidente local" %}}?</li>
        <li>Al este, Google Car es blanco.</li>
        <li>Puede limitar su área mirando el código de área. Comenzando desde el oeste, el primero es <span class="quiz">4-8-3-4</span>{{% by %}}</li>
    </ul>
</div>

{{% tabs %}}
{{% tab "península de kamchatka" %}}
...
{{% /tab %}}
{{% tab "coche con volante a la derecha" %}}
...
<div class="main-desciption area-description">
    ...
    <ul class="rule-list">
        <li>『<a href="https://docs.google.com/document/d/1drp1udLAXFNOMDvU0V6pLS2wLakmXujMepTUlkIbc_k/edit#heading=h.xu6byjwpm9nv">Una Rusia que se puede aprender: guía complementaria</a>"mientras lee"<a href="https://www.geoguessr.com/maps/6447040b0517cbd5807a5145">Una Rusia que se puede aprender</a>{{% ex "https://www.geoguessr.com/maps/6447040b0517cbd5807a5145" %}}"para practicar</li>
    </ul>
</div>

{{% tabs %}}
{{% tab "Vídeo explicativo" %}}
<div class="googlemap-if">
