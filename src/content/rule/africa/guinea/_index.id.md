...
<div class="main-desciption country-description">
    ...
    <ul class="rule-list">
        ...
        <li>Mobil pribadi sering memakai pelat <span class="quiz">merah</span>; taksi/kendaraan komersial pelat <span class="quiz">hitam</span>{{% ex "https://maps.app.goo.gl/x33vTiGvM73E5idd7" %}}.</li>
    </ul>
</div>
...
{{% notice tip %}}
Guinea merupakan salah satu produsen <span class="quiz">bauksit</span> terbesar di Afrika{{% ex "https://maps.app.goo.gl/oFWJApk89apmnfp1A" "https://maps.app.goo.gl/3auuzVSYRPKHZM7P8" %}}; tambang utama berada di barat laut dan tanah sering tampak kemerahan. Diagram ekspor (2019) di bawah.
{{% /notice %}}
...
<p><a href="https://commons.wikimedia.org/wiki/File:Guinea_Product_Exports_(2019).svg#/media/File:Guinea_Product_Exports_(2019).svg"><img src="https://upload.wikimedia.org/wikipedia/commons/3/31/Guinea_Product_Exports_%282019%29.svg" width="400px" alt="Wikimedia Commons photo showing Guinea Product Exports (2019)"></a></p>
</div>
