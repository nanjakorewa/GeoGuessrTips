...
<td>クラレ</td>
<td>{{% minkabu 3405 %}}</td>
<td>水島発祥だが京葉にも製造拠点。PVA（ポリビニルアルコール）・接着樹脂で世界シェア上位。革新的素材に強み。</td>
...
<td>信越化学工業</td>
<td>{{% minkabu 4063 %}}</td>
<td>京葉・鹿島など複数拠点。ポリ塩化ビニル・シリコーン樹脂・電子材料で国内最大級。</td>
...
<td>旭化成</td>
<td>{{% minkabu 3407 %}}</td>
<td>水島発祥だが複数地区で操業。LIBセパレーター・建材・医薬品・繊維で事業多角化。</td>
...
<td>トクヤマ</td>
<td>{{% minkabu 4043 %}}</td>
<td>周南コンビナート主力だが京葉にも製造拠点。ポリ塩化ビニル・ジクロロメタン・シリカゲル製造。</td>
