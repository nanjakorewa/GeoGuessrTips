...
| 4 | Vale | <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 10" width="18" height="12" style="vertical-align:-2px"><rect width="14" height="10" fill="#009b3a"/></svg> [ブラジル](/rule/cs_america/brazil/) | ~$45B | 鉄鉱石（カラジャス、ミナス）、ニッケル |
| 5 | Glencore | <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 9 6" width="18" height="12" style="vertical-align:-2px"><rect width="9" height="6" fill="#d52b1e"/><rect y="2" width="9" height="2" fill="#fff"/></svg> [スイス](/rule/europe/switzerland/) | ~$83B | 銅、コバルト、亜鉛、トレーディング |
