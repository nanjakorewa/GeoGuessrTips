...
<td>信越化学工業</td>
<td>{{% minkabu 4063 %}}</td>
<td>シリコンウェーハで世界首位（シェア約30%）の化学企業。300mm・450mmの大型高品質ウェーハをTSMC・ソニー・ルネサスなどの最先端メーカーに供給。フォトレジスト・電子材料でも世界的シェアを保有し、半導体製造の基盤素材産業を支配</td>
...
<td>SUMCO</td>
<td>{{% minkabu 3436 %}}</td>
<td>シリコンウェーハ専業で世界2位（シェア約26%）の大手企業。佐賀県伊万里地区を主力生産地とし、2024〜2025年に複数の新工場が相次ぎ稼働。TSMC熊本工場（JASM）への最短距離でのウェーハ供給体制を構築し、九州クラスター発展の重要なサプライチェーン合弁企業</td>
