...
熊本工場が生産する28nmプロセスは<span style="font-weight:700">成熟ノード</span>と呼ばれ、車載・産業機器・IoT向けに安定した需要があります。最先端の2nm以下と異なり、EUV露光装置を使わず既存のArFi露光で製造でき、設備投資を抑えつつ高い歩留まりを実現できます。
...
<td>東京エレクトロン</td>
<td>{{% minkabu 8035 %}}</td>
<td>半導体製造装置で世界第3位の大手企業。熊本県合志市に開発・生産子会社「東京エレクトロン九州」を置き、世界シェア1位の塗布現像装置（コーター・デベロッパー）を製造。TSMC・ソニー・ルネサスなど九州クラスターの主要企業に最先端装置を納入</td>
...
<td>信越化学工業</td>
<td>{{% minkabu 4063 %}}</td>
<td>シリコンウェーハで世界首位（シェア約42%）の化学企業。300mm・450mmの大型高品質ウェーハをTSMC・ソニー・ルネサスなどの最先端メーカーに供給。フォトレジスト・電子材料でも世界的シェアを保有し、半導体製造の基盤素材産業を支配</td>
...
<td>SUMCO</td>
<td>{{% minkabu 3436 %}}</td>
<td>シリコンウェーハ専業で世界2位（シェア約18%）の大手企業。佐賀県伊万里地区を主力生産地とし、2024〜2025年に複数の新工場が相次ぎ稼働。TSMC熊本工場（JASM）への最短距離でのウェーハ供給体制を構築し、九州クラスター発展の重要なサプライチェーン合弁企業</td>
