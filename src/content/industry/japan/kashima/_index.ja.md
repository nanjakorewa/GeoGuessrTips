...
<div class="stat-grid">
  <div class="stat-card">
    ...
    <p class="stat-card__unit">基（2023年稼働中）</p>
  </div>
  <div class="stat-card">
    <p class="stat-card__label">粗鋼生産能力</p>
    <p class="stat-card__value">約700</p>
    <p class="stat-card__unit">万トン/年（鹿島製鉄所）</p>
  </div>
  <div class="stat-card">
...
日本製鉄の鹿島製鉄所は1970年の操業開始以来、粗鋼年産能力約700万トンを誇る国内最大規模の一貫製鉄所のひとつです{{% cite "nipponsteel2023" %}}。
...
| 2011 | 東日本大震災で一時操業停止。約1.5ヶ月で復旧 |
| 2023 | 稼働高炉を4基→2基に集約（内需縮小への対応） |
...
| 会社 | 設備・規模 | 主な製品 |
|------|-----------|---------|
| 住友化学 鹿島工場 | エチレン能力 22.5万t/年 | エチレン・農薬・半導体材料 |
| 三菱ケミカル 鹿島事業所 | MMA製造装置 | MMA（アクリル酸メチル）・ポリエステル繊維原料 |
...
<td>日本製鉄</td>
<td>{{% minkabu 5401 %}}</td>
<td>国内最大の鉄鋼メーカー。鹿島製鉄所は5,370m³高炉2基を保有し、厚板・熱延を主力に年間約700万トンの粗鋼を生産。USスチール買収を推進中（2024年）。</td>
...
<td>住友化学</td>
<td>{{% minkabu 4005 %}}</td>
<td>鹿島工場でエチレン製造・農薬原体・MMA等を生産。半導体材料（フォトレジスト）事業も保有。2023年度に大幅な業績悪化で戦略的見直しを発表。</td>
...
<td>三菱ケミカルグループ</td>
<td>{{% minkabu 4188 %}}</td>
<td>鹿島事業所でMMA・MEG（エチレングリコール）・ポリエステル原料（PTA）を生産。MMAは世界シェア約30%で首位。</td>
...
kant2021: 関東地方整備局 鹿島港湾・空港整備事務所. 「鹿島港の現況」. 2021年. https://www.kanto.mlit.go.jp/
nipponsteel2023: 日本製鉄株式会社. 「有価証券報告書 2023年度」. 2023年. https://www.nipponsteel.com/ir/library/
jisf2023: 日本鉄鋼連盟. 「鉄鋼統計要覧 2023年版」. 2023年. https://www.jisf.or.jp/
{{% /references %}}
