...
<tr><td>Impala Platinum</td><td>IMP.JO</td><td>通称Implats、南ア・ヨハネスブルグ上場、世界2位のPGM生産者。南アブッシュフェルトのImpala Rustenburg（同社最大、世界有数）、ジンバブエのZimplats（87%、世界最大級のPGM埋蔵）、南アMarula、カナダImpala Canada（旧Lac des Iles、パラジウム主体）、2023年買収のRoyal Bafokeng PlatinumのStyldrift等を運営。</td><td>{{% corplink "https://www.implats.co.za/investor-relations.php" %}}</td><td>{{% dividend "other" "IMP.JO" %}}</td></tr>
<tr><td>Northam Platinum</td><td>NPH.JO</td><td>Northam Platinum Holdings、南ア・ヨハネスブルグ上場の独立系PGM生産者。ブッシュフェルト西部ZondereindeとBooysendal（北部リンポポ州）、2021年買収のEland/Eland Platinumを運営し、南ア3大PGMメジャー（Amplats・Implatsと並び）の一角。精錬所Zondereindeも保有し上流〜精錬まで一貫体制。</td><td>{{% corplink "https://www.northam.co.za/investors-and-media/overview" %}}</td><td>{{% dividend "other" "NPH.JO" %}}</td></tr>
</tbody></table>
</div>
