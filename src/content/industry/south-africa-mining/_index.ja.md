...
<tr><td>Gold Fields</td><td>GFI</td><td>金</td><td>{{% corplink "https://www.google.com/search?q=Gold Fields+Investor+Relations" %}}</td><td>{{% dividend "other" "GFI" %}}</td></tr>
<tr><td>Sibanye-Stillwater</td><td>SBSW</td><td>PGM・金</td><td>{{% corplink "https://www.google.com/search?q=Sibanye-Stillwater+Investor+Relations" %}}</td><td>{{% dividend "other" "SBSW" %}}</td></tr>
<tr><td>Harmony Gold</td><td>HMY</td><td>金</td><td>{{% corplink "https://www.google.com/search?q=Harmony Gold+Investor+Relations" %}}</td><td>{{% dividend "other" "HMY" %}}</td></tr>
<tr><td>Sasol</td><td>SSL</td><td>化学・石油</td><td>{{% corplink "https://www.google.com/search?q=Sasol+Investor+Relations" %}}</td><td>{{% dividend "other" "SSL" %}}</td></tr>
<tr><td>Anglo American Platinum</td><td>AMS.JO</td><td>PGM</td><td>{{% corplink "https://www.google.com/search?q=Anglo American Platinum+Investor+Relations" %}}</td><td>{{% dividend "other" "AMS.JO" %}}</td></tr>
<tr><td>Impala Platinum</td><td>IMP.JO</td><td>PGM</td><td>{{% corplink "https://www.google.com/search?q=Impala Platinum+Investor+Relations" %}}</td><td>{{% dividend "other" "IMP.JO" %}}</td></tr>
<tr><td>Northam Platinum</td><td>NPH.JO</td><td>PGM</td><td>{{% corplink "https://www.google.com/search?q=Northam Platinum+Investor+Relations" %}}</td><td>{{% dividend "other" "NPH.JO" %}}</td></tr>
</tbody></table>
</div>
