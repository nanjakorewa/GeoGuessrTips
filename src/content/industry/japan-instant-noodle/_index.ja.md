...
mapPins:
  - { lat: 34.694, lng: 135.502, label: "日清食品（大阪）", type: "noodle", note: "1958年チキンラーメン発祥・日清食品本社（大阪府大阪市）" }
  - { lat: 35.689, lng: 139.692, label: "東洋水産（東京）", type: "noodle", note: "マルちゃん本社（東京都港区）。北米シェア60%超" }
  - { lat: 37.566, lng: 126.978, label: "農心（ソウル）", type: "noodle", note: "辛ラーメン・農心本社（韓国ソウル）" }
  - { lat: 37.546, lng: 127.078, label: "サムヤン（ソウル）", type: "noodle", note: "プルダックポックンミョン・サムヤンフーズ（韓国）" }
  - { lat: -6.175, lng: 106.827, label: "インドフード（ジャカルタ）", type: "noodle", note: "インドミー・インドネシア圧倒的首位" }
  - { lat: 10.823, lng: 106.630, label: "エースコック（ホーチミン）", type: "noodle", note: "ハオハオ・ベトナム約40%シェア" }
  - { lat: 39.904, lng: 116.407, label: "中国（北京）", type: "market", note: "世界最大市場：年間438億食消費" }
  - { lat: 19.433, lng: -99.133, label: "メキシコ（メキシコシティ）", type: "market", note: "東洋水産マルちゃん約85%シェア" }
  - { lat: 33.954, lng: -118.339, label: "農心カリフォルニア工場", type: "factory", note: "2022年稼働・年間3.5億食生産能力（米国）" }
  - { lat: -23.550, lng: -46.633, label: "ブラジル（サンパウロ）", type: "market", note: "日清食品が味の素と合弁で展開・約65%シェア" }
  - { lat: 28.614, lng: 77.209, label: "インド（ニューデリー）", type: "market", note: "ネスレ「マギー」首位、年間約85億食市場" }
---

## 世界市場の概況

<figure style="float:right;clear:right;margin:0 0 14px 22px;max-width:min(420px,45%);">
  <img src="https://commons.wikimedia.org/wiki/Special:FilePath/Instant_ramen_packages_in_H_Mart.jpg?width=420" alt="インスタントラーメンの陳列" loading="lazy" style="width:100%;height:auto;border-radius:6px;display:block;" />
  <figcaption style="font-size:0.85em;color:#555;margin-top:6px;text-align:center;line-height:1.45;">米国のアジア系スーパーマーケット「H Mart」のインスタントラーメン売り場。日本発の発明（1958年・日清「チキンラーメン」）から始まったインスタント麺は、いまや韓国・中国・東南アジアメーカーも巻き込むグローバル市場へ成長しました。<br/>画像: <a href="https://commons.wikimedia.org/wiki/File:Instant_ramen_packages_in_H_Mart.jpg" target="_blank" rel="noopener noreferrer">Reconrabbit / Wikimedia Commons (CC0)</a></figcaption>
</figure>
