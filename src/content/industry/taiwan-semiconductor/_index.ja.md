...
<tr><td>MediaTek</td><td>2454.TW</td><td>聯發科技、台湾・新竹本社、世界最大のスマートフォン向けアプリケーションプロセッサ（SoC）「Dimensity」シリーズを中心とするファブレス半導体企業。グローバルのスマホチップ出荷量でQualcommと拮抗する世界トップクラス。WiFi/Bluetooth、Smart TV SoC、電源管理ICも手掛け、TSMC・UMCで製造委託。</td><td>{{% corplink "https://corp.mediatek.com/investors" %}}</td><td>{{% dividend "other" "2454.TW" %}}</td></tr>
