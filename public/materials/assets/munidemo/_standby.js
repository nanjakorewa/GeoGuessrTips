...
function buildStandby(CFG) {
  ...
  /* ---------- 上下の文字 ---------- */
  document.getElementById("headText").textContent = CFG.heading || "まもなく開始";
  document.getElementById("headEn").textContent = CFG.headingEn || "STARTING SOON";
  document.getElementById("footNote").textContent = CFG.foot || "";
